...
The author would like to thank the SCX Research Group for providing computing resources. The AlN interatomic potential function and associated DFT reference data were provided by the SCX Research Group and are used with permission; these data remain the intellectual property of the SCX Research Group.
...
The author declares that the SCX software may be commercialized through a future entity. The author has no competing interests with respect to the AlN data, which belong to the SCX Research Group.
