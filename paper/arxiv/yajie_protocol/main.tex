...
Furthermore, the timing of protection is itself a signal. A leader who protects at $t_0 + \Delta$ (immediately after the proofs can be verified) reveals competent strategic reasoning. A leader who protects at $t_0 + 5\text{ years}$ reveals that it took five years to compute the payoff matrix—or that the leader waited to see whether the Maintainer would be eliminated by someone else first. Delay is not neutral. Delay is evidence of low strategic competence, or worse.
\end{remark}
