...
Institute for Data Governance and Algorithmic Audit}
\date{June 2026}
...
\begin{description}
\item[Ada Lovelace Institute.] (2020). \textit{Examining the Black Box: Tools for Assessing Algorithmic Systems}. London.

\item[Armstrong, M.] (2006). Competition in two-sided markets. \textit{The RAND Journal of Economics}, 37(3), 668–691.
...
\item[Bateman, J.] (2022). \textit{U.S.-China Technological ``Decoupling'': A Strategy and Policy Framework}. Carnegie Endowment.

\item[Batini, C., Cappiello, C., Francalanci, C., \& Maurino, A.] (2009). Methodologies for data quality assessment and improvement. \textit{ACM Computing Surveys}, 41(3), 1–52.

\item[David, P. A.] (1985). Clio and the economics of QWERTY. \textit{The American Economic Review}, 75(2), 332–337.

\item[Diakopoulos, N.] (2015). Algorithmic accountability. \textit{Digital Journalism}, 3(3), 398–415.

\item[Drezner, D. W.] (2015). Targeted sanctions in a world of global finance. \textit{International Interactions}, 41(4), 755–764.

\item[European Commission.] (2021). \textit{Proposal for a Regulation Laying Down Harmonised Rules on Artificial Intelligence}. COM(2021) 206 final.

\item[Farrell, H., \& Newman, A. L.] (2019). Weaponized interdependence. \textit{International Security}, 44(1), 42–79.

\item[Farrell, J., \& Klemperer, P.] (2007). Coordination and lock-in. In \textit{Handbook of Industrial Organization} (Vol. 3, pp. 1967–2072). Elsevier.

\item[Farrell, J., \& Saloner, G.] (1985). Standardization, compatibility, and innovation. \textit{The RAND Journal of Economics}, 16(1), 70–83.

\item[Floridi, L., et al.] (2018). AI4People—An ethical framework for a good AI society. \textit{Minds and Machines}, 28(4), 689–707.

\item[Gebru, T., et al.] (2021). Datasheets for datasets. \textit{Communications of the ACM}, 64(12), 86–92.

\item[Gregory, R. W., et al.] (2021). The role of artificial intelligence and data network effects. \textit{Academy of Management Review}, 46(3), 534–551.

\item[Jobin, A., Ienca, M., \& Vayena, E.] (2019). The global landscape of AI ethics guidelines. \textit{Nature Machine Intelligence}, 1(9), 389–399.

\item[Joyner, D. H.] (2011). \textit{Interpreting the Nuclear Non-Proliferation Treaty}. Oxford University Press.

\item[Kaplan, J., et al.] (2020). Scaling laws for neural language models. \textit{arXiv preprint arXiv:2001.08361}.

\item[Katz, M. L., \& Shapiro, C.] (1985). Network externalities, competition, and compatibility. \textit{The American Economic Review}, 75(3), 424–440.

\item[Khan, L. M.] (2017). Amazon's antitrust paradox. \textit{Yale Law Journal}, 126(3), 710–805.

\item[Mearsheimer, J. J.] (1993). The case for a Ukrainian nuclear deterrent. \textit{Foreign Affairs}, 72(3), 50–66.

\item[M\"{o}kander, J., et al.] (2021). Ethics-based auditing of automated decision-making systems. \textit{Science and Engineering Ethics}, 27(4), 1–30.

\item[NIST.] (2023). \textit{Artificial Intelligence Risk Management Framework 1.0}. U.S. Department of Commerce.

\item[Northcutt, C. G., Athalye, A., \& Mueller, J.] (2021). Pervasive label errors in test sets destabilize machine learning benchmarks. \textit{NeurIPS 2021}.

\item[Parasuraman, R., \& Riley, V.] (1997). Humans and automation: Use, misuse, disuse, abuse. \textit{Human Factors}, 39(2), 230–253.

\item[Parker, G. G., \& Van Alstyne, M. W.] (2005). Two-sided network effects. \textit{Management Science}, 51(10), 1494–1504.

\item[Pushkarna, M., et al.] (2022). Data cards: Purposeful and transparent dataset documentation. \textit{FAccT '22}, 1776–1826.

\item[Raji, I. D., et al.] (2020). Closing the AI accountability gap. \textit{FAccT '20}, 33–44.
...
\item[Sagan, S. D.] (1996). Why do states build nuclear weapons? \textit{International Security}, 21(3), 54–86.

\item[Sambasivan, N., et al.] (2021). ``Everyone wants to do the model work, not the data work.'' \textit{CHI 2021}, 1–15.

\item[Sandvig, C., et al.] (2014). Auditing algorithms. \textit{Data and Discrimination}, 1–23.

\item[Segal, A.] (2020). The coming tech Cold War with China. \textit{Foreign Affairs}, 99(5), 94–105.

\item[Waltz, K. N.] (1981). The spread of nuclear weapons: More may be better. \textit{The Adelphi Papers}, 21(171), 1–32.

\item[Wang, R. Y., \& Strong, D. M.] (1996). Beyond accuracy: What data quality means to data consumers. \textit{Journal of Management Information Systems}, 12(4), 5–33.

\item[Wilson, C., et al.] (2021). Building and auditing fair algorithms. \textit{FAccT '21}, 666–677.

\item[Zeff, S. A.] (2012). The evolution of the IASC into the IASB. \textit{The Accounting Review}, 87(3), 807–837.

\item[Zhang, Y., \& Andrew, J.] (2014). Financialisation and the conceptual framework. \textit{Critical Perspectives on Accounting}, 25(1), 17–26.
\end{description}
