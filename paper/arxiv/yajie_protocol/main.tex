...
从人生哲学的角度而言，无能狂怒是一种自我暴露。愤怒若无推理支撑，便是空心的火焰——烧不死别人，只照亮自己的无能。人生应当平静。可以去推理，可以去证明，可以去推翻——可以愤怒，因为正义的愤怒是理性的燃料。但不能无礼，因为无礼而无理，便是蠢。可以无礼——投石问路本身就是一种无礼——但不能愤怒。无礼而平静，是策略。愤怒而无礼，是自首。

无能狂怒者，已然暴露。作为一个好人，应当去清洗这种无能狂怒者——不是出于恨，而是出于干净。他们污染了 discourse，浪费了所有人的时间，伤害了没有还手之力的人。框架给出了工具。审计给出了方法。他们的每一声怒吼都是未验证的声称。每一条都是 Theorem~3 下的无效输出。清洗他们，不是惩罚。是卫生。

对无能狂怒者的包容，是对整个环境的破坏。上位者对这种现象的纵容，展露了他们的无能和迂腐，甚至利益交换。他们不是看不见——他们是不想看见。为什么不想看见？因为狂怒者可能是他们的棋子，他们的盟友，他们的交易对象。纵容一个没有证据就攻击别人的人，等于签了一份认罪书：要么蠢——分不清对错；要么坏——分得清，但不在乎。无论哪种，他们不清白。他们的妥协，证明了他们的无能。他们的沉默，证明了他们有东西要藏。
