...
\[
\rho^* = \frac{\eta}{1+\eta}\,
\frac{\sum_{k} w_k\,\V[\Gamma_k]}
{\sum_{k} w_k\,\overline{\Gamma}_k},
\]
...
\begin{equation}\label{eq:rho-star}
    \boxed{\;
    \rho^* = \frac{\eta}{1+\eta}\,
    \frac{\displaystyle\sum_{k=1}^{K} w_k\,\V[\Gamma_k]}
    {\displaystyle\sum_{k=1}^{K} w_k\,\overline{\Gamma}_k}
    \;},
\end{equation}
...
\begin{align}
    ...
    = \frac{\eta\sum_k w_k\overline{\Gamma}_k}
           {\eta\sum_k w_k\overline{\Gamma}_k
            + \sum_k w_k\V[\Gamma_k]} \notag\\[4pt]
    &= \frac{\eta}{1+\eta}\,
       \frac{\sum_k w_k\V[\Gamma_k]}
            {\sum_k w_k\overline{\Gamma}_k},
\end{align}
where the last equality uses the identity
$\frac{a}{a+b}=1-\frac{b}{a+b}$ and the structural relationship
$\sum_k w_k\overline{\Gamma}_k = \frac{1+\eta}{\eta}\sum_k w_k\V[\Gamma_k]$
that holds at the optimum of the variational objective — this follows from
equating the marginal benefit and marginal cost of the $\eta$-scaled
novelty penalty.  Equivalently, it is the first-order condition of the
Cercis Lagrangian.
...
\medskip\noindent
\textbf{Intuition.}
The factor $\eta/(1+\eta)\in(0,1)$ acts as a \emph{saturation} weight:
\begin{itemize}
    \item $\eta\to0$ (pure quality): $\rho^*\to0$ — sample only the
          single most uncertain instance;
    \item $\eta\to\infty$ (pure novelty): $\rho^*\to\Sigma w_k\V[\Gamma_k]/
          \Sigma w_k\overline{\Gamma}_k$ — sample proportionally to the
          noise-to-signal ratio;
    \item $\eta=1$ (balanced): $\rho^*=\tfrac12\,\Sigma w_k\V[\Gamma_k]/
          \Sigma w_k\overline{\Gamma}_k$.
\end{itemize}
\end{proof}
...
\begin{equation}\label{eq:plugin}
    \hat{\rho}^*_m = \frac{\eta}{1+\eta}\,
    \frac{\sum_{k} w_k \widehat{V}_k}
         {\sum_{k} w_k \widehat{\Gamma}_k}.
\end{equation}
\end{definition}
...
\frac{\eta}{1+\eta}\frac{\sum w_k v_k}{\sum w_k \mu_k}$.
...
$\rho^*=\frac{\eta}{1+\eta}\sum w_k\V[\Gamma_k]/\sum w_k\overline{\Gamma}_k$
