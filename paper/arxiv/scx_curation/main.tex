...
%   (SCX, companion paper, referred to as Paper I)
% ============================================================
...
\begin{flushleft}
\textbf{Companion Paper.} This paper is accompanied by a theoretical companion, ``A Fundamental Impossibility in Data Quality'' (SCX, companion paper), which provides the complete mathematical framework: Theorem~1 (noise detection guarantee), Theorem~2 (weak-feature bound), Theorem~3 (unidentifiability), Theorem~4' (exact constant minimax optimality), Theorem~5 (cluster consistency), and Proposition~6 (bootstrap stability diagnostic). All theorems are referenced herein as Paper~I.
...
\bibitem{xi2025fundamental} SCX Research Group. A Fundamental Impossibility in Data Quality: Distinguishing Label Noise from Sample Difficulty is Provably Unsolvable Without Explicit Assumptions. arXiv preprint (2025).
\end{thebibliography}
