% ============================================================
% S3: Theorem 3 -- Noise-Difficulty Unidentifiability
% Supplementary Information for Nature submission:
% "A Fundamental Impossibility in Data Quality"
% ============================================================

\section{Theorem 3: Noise-Difficulty Unidentifiability}
\label{sec:thm3}
...
\begin{theorem}[Noise-Difficulty Unidentifiability]
...
\begin{itemize}
  \item \textbf{State $s_1$} (``clean but noisy''), with
    ...
    Labels are flipped with probability $\eta$:
    \[
...
\begin{itemize}
  \item \textbf{State $s_1$}, with the same marginal probability $\rho$.
    ...
    \[
    \mathbb{P}(y^*=0 \mid x\in s_1)=1-\eta,\qquad
    \mathbb{P}(y^*=1 \mid x\in s_1)=\eta.
    \]
...
&= (1-\eta)\cdot1 + \eta\cdot0 = 1-\eta,\\
\mathcal{P}_{\text{noise}}(y=1\mid s_1)
&= (1-\eta)\cdot0 + \eta\cdot1 = \eta.
\end{aligned}
\]
In World B (state $s_1$), $y=y^*$ directly:
\[
\mathcal{P}_{\text{hard}}(y=0\mid s_1)=1-\eta,\qquad
...
&= (1-\eta)(1-\varepsilon_1) + \eta(1-\varepsilon_1) = 1-\varepsilon_1,\\[4pt]
\mathcal{P}_{\text{hard}}(f_m=1\mid s_1)
&= (1-\eta)\varepsilon_1 + \eta\varepsilon_1 = \varepsilon_1.
\end{aligned}
\]
...
% ============================================================
% Cross-Reference: Theorem~3 (Noise-Difficulty Unidentifiability / SCX's
