...
The author is affiliated with the SCX Research Group. All theoretical work was done on a personal computer at home, using Claude Code (Anthropic) and DeepSeek API as implementation tools.
...
The author thanks:
\begin{itemize}
\item SCX Research Group for the AlN DFT data and EGP project context that sparked the initial observation
...
\bibitem{liu2006} Liu, C. \textit{Remembrance of Earth's Past} (三部曲). Chongqing Press (2006--2010).

\bibitem{liu2008} Liu, C. \textit{The Dark Forest} (黑暗森林). Chongqing Press (2008).

\bibitem{liu2010} Liu, C. \textit{Death's End} (死神永生). Chongqing Press (2010).
...
\bibitem{perdew1996} Perdew, J. P., Burke, K. \& Ernzerhof, M. Generalized gradient approximation made simple. \textit{Physical Review Letters} \textbf{77}(18), 3865--3868 (1996).

\bibitem{drautz2019} Drautz, R. Atomic cluster expansion for accurate and transferable interatomic potentials. \textit{Physical Review B} \textbf{99}, 014104 (2019).

\bibitem{lysogorskiy2021} Lysogorskiy, Y., van der Oord, C., Bochkarev, A., Menon, S., Rinaldi, M., Hammerschmidt, T., Mrovec, M., Thompson, A., Cs\'anyi, G., Ortner, C. \& Drautz, R. Performant implementation of the atomic cluster expansion (PACE) and application to copper and silicon. \textit{npj Computational Materials} \textbf{7}, 97 (2021).

\bibitem{wolpert1997} Wolpert, D. H. \& Macready, W. G. No free lunch theorems for optimization. \textit{IEEE Transactions on Evolutionary Computation} \textbf{1}(1), 67--82 (1997).

\bibitem{turing1937} Turing, A. M. On computable numbers, with an application to the Entscheidungsproblem. \textit{Proceedings of the London Mathematical Society} \textbf{s2-42}(1), 230--265 (1937).

\bibitem{heisenberg1927} Heisenberg, W. \"{U}ber den anschaulichen Inhalt der quantentheoretischen Kinematik und Mechanik. \textit{Zeitschrift f\"{u}r Physik} \textbf{43}(3--4), 172--198 (1927).

\bibitem{sennrich2016} Sennrich, R., Haddow, B. \& Birch, A. Neural machine translation of rare words with subword units. \textit{Proc. ACL} (2016).

\bibitem{vaswani2017} Vaswani, A., Shazeer, N., Parmar, N., Uszkoreit, J., Jones, L., Gomez, A. N., Kaiser, L. \& Polosukhin, I. Attention is all you need. \textit{Proc. NeurIPS} (2017).

\bibitem{scx2025theory} SCX Research Group. Detecting Label Noise by State-Conditioned eXpertise. arXiv preprint (2025).

\bibitem{scx2025spring} SCX Research Group. Spring: A Self-Evolving Gatekeeper with Lyapunov Convergence Guarantees. arXiv preprint (2025).

\bibitem{scx2025situs} SCX Research Group. Situs: Physics-Anchored Positional Encoding for State-Conditioned Expertise. arXiv preprint (2025).

\bibitem{scx2025yajie} SCX Research Group. The Yajie Protocol: Technology Lock-in, Audit Sovereignty, and the Non-Proliferation Logic of Data Quality Assessment. arXiv preprint (2025).
