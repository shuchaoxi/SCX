...
Before committing to the full SCX pipeline, we recommend a lightweight diagnostic based on bootstrap stability (Proposition~6 in Paper~I~\cite{xi2025fundamental}). The procedure is:
