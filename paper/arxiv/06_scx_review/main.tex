...
\begin{enumerate}[nosep,leftmargin=*,itemsep=1pt]
  ...
  \item \textbf{Openly licensed.} The complete SCX codebase is released . The mathematical proofs are in the public domain. The experimental protocols are documented for independent reproduction.
