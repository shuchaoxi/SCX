...
这是\eqref{eq:grad-signature}的经验版本.

\subsection{旋度统计量$\tau$的渐近理论}

\begin{lemma}[旋度统计量的H_0渐近分布]\label{lem:tau-null}
...
\begin{proof}[Lemma~\ref{lem:tau-null}的证明概要]
    ...
    由于H_0下$S(x)$仅依赖于$\varepsilon$(与$x$独立),
...
\begin{lemma}[旋度统计量的H_1偏移]\label{lem:tau-alt}
