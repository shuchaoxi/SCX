...
\textbf{Dataset.} 534 DFT frames for aluminium nitride, each containing atomic positions, species, energies, and forces. 74 frames (14\%) carry label noise from thermal and molecular dynamics simulations at 1800~K (force error $> 5$~eV/{\AA}).
