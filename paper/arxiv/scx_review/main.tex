...
\bibitem{paperI}
SCX Research Group. State-conditioned expertise: Mathematical foundations for data quality assessment. \emph{arXiv preprint} (2026).

\bibitem{paperII}
SCX Research Group. The curation-exploration tradeoff: A theoretical and empirical analysis. \emph{arXiv preprint} (2026).

\bibitem{paperIII}
SCX Research Group. Cross-domain experimental validation of the SCX framework. \emph{arXiv preprint} (2026).

\bibitem{paperIV}
SCX Research Group. SCX for machine-learned interatomic potentials: Expert merging and noise detection. \emph{arXiv preprint} (2026).

\bibitem{paperV}
SCX Research Group. SCX for LLM data curation: State-conditioned multi-judge calibration. \emph{In preparation} (2026).

\bibitem{theorems_unified}
SCX Research Group. Unified theorem document: Theorems 1--7 of the SCX framework. \emph{Technical Report} (2026).

\bibitem{engineering_guide}
SCX Research Group. SCX engineering guide: Practical deployment across domains. \emph{Technical Report} (2026).

\bibitem{deep_math}
SCX Research Group. Deep mathematical structure of the SCX framework. \emph{Companion analysis} (2026).

\bibitem{scxlife}
SCX Research Group. SCX-Life: Domain-specific instantiation for life sciences. \emph{Technical Report} (2026).

\bibitem{targetome_top10}
SCX Research Group. TOP-10 drug target identification via the SCX-Drug pipeline. \emph{Technical Report} (2026).

\bibitem{drug_state}
SCX Research Group. TargetProfileState: State-conditioned drug-target modeling. \emph{Technical Report} (2026).

\bibitem{noise_module}
SCX Research Group. SCX-Noise: Multi-expert label noise detection for medical imaging. \emph{Technical Report} (2026).

\bibitem{routing_module}
SCX Research Group. SCX-Routing: State-conditioned expert routing. \emph{Technical Report} (2026).

\bibitem{compress_module}
SCX Research Group. SCX-Compress: State-conditioned data compression. \emph{Technical Report} (2026).
...
SCX Research Group. The Yajie Protocol: Technology lock-in, audit sovereignty, and the non-proliferation logic of data quality assessment. \emph{Technical Report} (2026).
