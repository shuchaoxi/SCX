...
\bibitem{paperI}
SCX. A Fundamental Impossibility in Data Quality: Distinguishing Label Noise from Sample Difficulty is Provably Unsolvable Without Explicit Assumptions. \emph{arXiv preprint} (2026).

\bibitem{paperII}
SCX. The Curation-Exploration Tradeoff: Why Premature Data Cleaning Harms Machine Learning. \emph{In preparation} (2026).

\bibitem{paperIII}
SCX. Training Data Quality Dominates Model Architecture in Scientific Machine Learning. \emph{In preparation} (2026).

\bibitem{paperIV}
SCX. Consistency-Constrained Expert Merging for Atomic Cluster Expansion Potentials. \emph{arXiv preprint} (2026).

\bibitem{paperV}
SCX. SCX for LLM Data Curation. \emph{In preparation} (2026).

\bibitem{theorems_unified}
SCX Mathematical Theory: Unified Theorem Document. \emph{Technical report} (2026).
...
SCX-Drug Targetome TOP-10 Screening Report. \emph{SCX Platform Technical Report} (2026).
...
\bibitem{drug_state}
SCX-Drug State Module. \texttt{scx-life/drug/state.py}.

\bibitem{dti_module}
SCX-Drug DTI Operators. \texttt{scx-life/drug/operators/dti.py}.
