...
\textbf{Life Sciences} & Drug Discovery & ECFP4/MACCS/RDKit & k-means on mol. features & 5--10 & 4 & Tier 2 (KB as expert) & Validated \\
 ...
 & Genomics (proposed) & Protein LM embeddings & k-means / spectral & TBD & TBD & Tier 2 & Proposed \\
\midrule
\textbf{Adv. Manufacturing} & MLIP & SOAP/ACE descriptors & k-means on descriptors & 4--8 & 8--12 & Tier 3 (adaptive) & Validated \\
 & Quality control (prop.) & Sensor TCN embeddings & k-means / HMM & TBD & 5--10 & Tier 1/2 & Proposed \\
 & Process optimization & Process params + PCA & k-means & TBD & TBD & Tier 1 & Theoretical \\
\midrule
\textbf{Embodied Intell.} & Robot learning (prop.) & Trajectory autoencoders & k-means on traj. emb. & TBD & 5--8 & Tier 2 & Proposed \\
 & Sim-to-real (prop.) & Domain-randomized feats. & k-means & TBD & 5--10 & Tier 2 & Theoretical \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{AI} & Computer Vision & ResNet/SiCNN features & k-means on features & 8--10 & 5--20 & Tier 2/3 & Validated \\
 & NLP (proposed) & BERT/T5 embeddings & k-means & TBD & 5--10 & Tier 2/3 & Proposed \\
 & RL (theoretical) & State-action embeddings & k-means & TBD & 3--5 & Tier 1 & Theoretical \\
\midrule
\textbf{Autonomous Driv.} & Perception (prop.) & LiDAR+camera features & k-means / spectral & TBD & 5--10 & Tier 2/3 & Proposed \\
 & Behavior pred. (prop.) & Agent-history embeddings & k-means & TBD & 5--8 & Tier 2 & Proposed \\
 & Safety (prop.) & Multi-modal fusion & k-means & TBD & 10--20 & Tier 3 & Theoretical \\
\midrule
\textbf{Natural Sciences} & Physics (DFT) & Functional labels + features & KB-defined & 3--5 & 3--5 & Tier 1 & Theoretical \\
 & Chemistry (prop.) & Molecular graphs & k-means & TBD & 5--8 & Tier 2 & Proposed \\
 & Cryo-EM (prop.) & Micrograph patch features & k-means / spectral & TBD & 3--5 & Tier 1 & Theoretical \\
 & Earth science (prop.) & Spatial-temporal features & k-means / geo-clust. & TBD & 5--20 & Tier 2 & Theoretical \\
\bottomrule
\end{tabular}
\vspace{0.2cm}
\end{table}
...
\subsubsection*{Theorem 3: Noise-Difficulty Unidentifiability}
...
Xi, S. SCX Mathematical Theory: Unified Theorem Document. \emph{Technical report} (2026). Available at: \url{https://github.com/SCX-Platform/scx-theory}.

\bibitem{engineering_guide}
Xi, S. SCX Engineering Practice Guide. \emph{Technical report} (2026).

\bibitem{paperI}
Xi, S. \& Claude. A Fundamental Impossibility in Data Quality. \emph{arXiv preprint} (2026).

\bibitem{paperII}
Xi, S. \& Claude. The Curation-Exploration Tradeoff. \emph{In preparation} (2026).

\bibitem{paperIII}
Xi, S. \& Claude. Training Data Quality Dominates Model Architecture. \emph{In preparation} (2026).
