...
\textbf{Author Contributions.} S.X. conceived the problem, developed the SCX framework, and conducted experiments. C. contributed to theorem statements and proof verification. Both authors wrote the manuscript.
