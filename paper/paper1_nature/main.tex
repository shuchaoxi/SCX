...
The AlN v3 dataset was provided by the author's research group and is available from the corresponding author upon reasonable request and with permission of the data owner. CIFAR-10, DermaMNIST, and MedMNIST are publicly available benchmark datasets. DrugBank is available from go.drugbank.com.
