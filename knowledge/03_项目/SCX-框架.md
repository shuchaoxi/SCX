...
| 核心定理 | **3**：定理 1（噪声检测保证）+ 定理 2（弱特征失败下界）+ 定理 3（噪声不可辨识性） |
...
| v0.4.0-pre | 06-27 | **定理 1+2+3 完成**：噪声检测保证 + 弱特征失败下界 + 不可辨识性；StateValue 重构（V(s) deprecated）；Yajie 模块创建；427 tests；独立验证修复 5 bugs；08_说明书/ 7 文件；论文路线图 4→5；Arrow analogy 归档 |
