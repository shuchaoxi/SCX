...
\noindent\textbf{Tier 2 — \weakness{} PARTIAL ($0.45 \le S \le 0.70$, 部分满足):} Bagging, CNN, Diffusion, Stacking, Transfer Learning. These have audit structure but critical gaps.

\noindent\textbf{Tier 3 — \guilty{} UNDECLARED ($S < 0.55$, 未声明):} The remaining 19 algorithms. Failure modes cluster into five categories:
