...
{\bf 图 $1$-拉普拉斯}为：
\[
    \Lone := d_0 \dzeroT = B W_0^{-1} B^T W_1.
\]
\end{definition}
...
The {\bf graph $1$-Laplacian} is: $\Lone := d_0 \dzeroT = B W_0^{-1} B^T W_1$.
...
The continuous fiber bundle framework is superﬂuous here, and even harmful,
