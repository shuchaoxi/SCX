\section{SCX
框架完整模块分析}<!-- label: scx-ux6846ux67b6ux5b8cux6574ux6a21ux5757ux5206ux6790 -->
...
\subsection{模块 1：状态发现与表示 (State Discovery \&
...
\subsection{模块 2：专家可靠性估计 (Expert Reliability
...
\paragraph{3.2.1 可学习性分数 (Learnability
...
\paragraph{3.2.2 一致性度量 (Consistency
...
\paragraph{3.2.4 冗余度估计 (Redundancy
...
\subsection{模块 4：状态数据估值 (State Data
...
\paragraph{4.2.1 采集价值 (Acquisition
...
\paragraph{4.2.2 压缩价值 (Compression
...
\paragraph{4.2.4 与 Influence Function
...
\subsection{模块 5：专家路由与仲裁 (Expert Routing \&
...
\paragraph{5.2.4 仲裁策略 (Arbitration
...
\paragraph{6.2.1 冗余分数 (Redundancy
...
\paragraph{6.2.5 与 Coreset Selection
...
\paragraph{6.2.6 与 Dataset Distillation
...
\subsection{模块 7：主动学习策略 (Active Learning
...
\paragraph{7.2.4 从 Point-wise 到 State-wise
...
\paragraph{7.2.6 与 D-optimality
...
\subsubsection{8.3 Paper 1: Gauge-Normalized Expert Merging → SCX 的
Expert Reliability
...
\subsubsection{8.4 Paper 2: Residual-State Error Maps → SCX 的 State
...
\subsubsection{8.5 Paper 3: Expert Compiler Distillation → SCX 的 Expert
Routing + Teacher
