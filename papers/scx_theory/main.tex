...
\bibitem{vapnik1998} Vapnik, V. N. \textit{Statistical Learning Theory}. Wiley (1998).

\bibitem{goodfellow2016} Goodfellow, I., Bengio, Y. \& Courville, A. \textit{Deep Learning}. MIT Press (2016).

\bibitem{hastie2009} Hastie, T., Tibshirani, R. \& Friedman, J. \textit{The Elements of Statistical Learning}, 2nd ed. Springer (2009).

\bibitem{breiman2001} Breiman, L. Statistical modeling: The two cultures. \textit{Statistical Science} \textbf{16}(3), 199--231 (2001).

\bibitem{dawid1979} Dawid, A. P. \& Skene, A. M. Maximum likelihood estimation of observer error-rates using the EM algorithm. \textit{Applied Statistics} \textbf{28}(1), 20--28 (1979).

\bibitem{raykar2010} Raykar, V. C., Yu, S., Zhao, L. H., Valadez, G. H., Florin, C., Bogoni, L. \& Moy, L. Learning from crowds. \textit{Journal of Machine Learning Research} \textbf{11}, 1297--1322 (2010).
