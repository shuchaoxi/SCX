...
% ===================================================================
\subsection{Conjecture: 好人收敛定理 (Good Person Convergence)}
\label{sec:good-convergence}

\begin{conjecture}[好人收敛定理 (Good Person Convergence Conjecture)]
...
Under the \textbf{SCX 公理体系 (SCX Axiom System)} E1--E5 and the SCX framework conditions A1--A6
