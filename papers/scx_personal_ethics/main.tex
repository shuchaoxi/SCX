...
(2)~Scale Invariance of Guilt (, formalized): a small deception and a large deception face identical detection probability whenever both exceed the noise threshold---there is no ``safe'' size of dishonesty;
...
\medskip
\noindent{\small\bfseries Keywords:} game theory , individual ethics ,
strict dominance , multi-expert audit ,
Hoeffding inequality, Spring permanent memory Spring,
Nash equilibrium , .
...
\subsection{You, Your Superior, and the Spreadsheet }

You work in an organization. It could be a government bureau compiling economic statistics (), a corporation reporting emissions data (), a hospital recording patient outcomes (), a school submitting examination results (), or a laboratory measuring product safety (). One day, your superior asks you to change a number. Not by much---just a small adjustment. ``Nobody will notice,'' they say. ``Everyone does it.''

You face a choice:
\begin{itemize}[nosep]
    \item \textbf{Comply} (, $\dishonest$): Falsify the data. Gain a benefit $b > 0$: a promotion, a bonus, continued employment, the superior's approval. Risk: detection.
    \item \textbf{Refuse} (, $\honest$): Report the truth. Gain nothing extra. Risk: retaliation from the superior---but the data remain clean.
\end{itemize}

Traditional ethics addresses this with moral language: courage (), integrity (), conscience (). These are real, but they ask you to sacrifice self-interest for principle. Not everyone finds that argument compelling under pressure.
...
\subsection{The Agent and the Truth }

\begin{definition}[Truth and Claim ]
\label{def:truth}
...
\subsection{The Auditors }

\begin{definition}[Multi-Expert Audit ]
\label{def:auditors}
...
\begin{definition}[Honest Consensus ]
\label{def:consensus}
...
\begin{definition}[Detection Event ]
\label{def:detection}
...
\begin{definition}[Individual Payoff ]
\label{def:payoff}
...
\begin{remark}[Yajie NPE Payoff Structure \Yajie{}]
\label{rem:yajie}
...
\subsection{Spring Permanent Memory \Spring{}}

\begin{definition}[Spring Memory \Spring{}]
\label{def:spring}
...
% ======================================================================
\section{Theorem 1 --- Detection Inevitability }
\label{sec:thm1}
% ======================================================================
...
\begin{theorem}[Detection Inevitability ]
...
\begin{remark}[Hoeffding Connection Hoeffding]
\label{rem:hoeffding}
...
% ======================================================================
\section{Theorem 2 --- Scale Invariance of Guilt }
\label{sec:thm2}
% ======================================================================

In the year 223, on his deathbed, the Shu Han emperor  (Liu Bei) gave his son  (Liu Shan) a final instruction, recorded in the \textit{} (Records of the Three Kingdoms):
...
\begin{theorem}[Scale Invariance of Guilt --- ]
...
\medskip
\noindent\textbf{Why this is the mathematical translation of .}
...
The ancient advice ---do not commit an evil because it is small---is usually understood as a moral claim: small evils corrupt character. We have shown it is also a mathematical claim: in multi-expert audit, small evils face the same probability of exposure as large ones. The ``smallness'' of the deception does not make it safer.
\end{proof}

\begin{corollary}[No Safe Harbor ]
...
% ======================================================================
\section{Theorem 3 --- Honesty as Strictly Dominant Strategy }
\label{sec:thm3}
% ======================================================================
...
\subsection{Benefit Structure Refinement }
...
\begin{assumption}[A7, Refined: Thresholded Benefit ]
\label{ass:A7}
...
\begin{theorem}[Honesty as Strictly Dominant Strategy ]
\label{thm:dominance}
\rigorFull
...
\subsection{Interpretation of $M_{\min}$ $M_{\min}$}
...
\begin{corollary}[Computability of $M_{\min}$ $M_{\min}$]
...
% ======================================================================
\section{Theorem 4 --- Irreversibility of Evidence (\Spring{}'s Permanent Memory) }
\label{sec:thm4}
% ======================================================================
...
\begin{theorem}[Irreversibility of Evidence --- \Spring{}'s Monotonicity ]
...
\begin{corollary}[No Strategic Timing ]
\label{cor:no_timing}
...
% ======================================================================
\section{The Personal Corollary --- What This Means for You }
\label{sec:corollary}
% ======================================================================

The theorems above are not abstractions. They are operational guidance. Here is what they mean for \textbf{you} (), the individual facing a superior's demand to falsify data.

\subsection{You Do Not Need Courage }

Traditional advice tells you to ``be brave'' (), to ``stand up for what is right'' (). This advice is noble. It is also unnecessary.
...
\subsection{Your Superior Is Not the Auditor }
...
\subsection{When $M < M_{\min}$: The Pre-Audit World }
...
\subsection{What the Theorem Cannot Do }
...
This is not a mathematical limitation of the theorems. It is a limitation of what audit alone can achieve. Audit detects lies; it does not prevent coercion. The full protection of honest individuals requires institutional complements: whistleblower laws (), anonymous reporting channels (), employment protections (), and---most fundamentally---a sufficiently large $M$ that includes auditors outside the superior's chain of command.
...
% ======================================================================
\section{Discussion --- When the Individual Is Also an Auditor }
\label{sec:discussion}
% ======================================================================

\subsection{The Dual Role }

Every citizen in an \SCX{}-audited system occupies two positions simultaneously:

\begin{enumerate}[label=(\roman*)]
    \item \textbf{Agent} (): You produce data. You face pressure to falsify it. Theorem~\ref{thm:dominance} tells you that honesty is strictly dominant.
    \item \textbf{Auditor} (): You possess information that can detect others' falsifications. Your observations, your local knowledge, your domain expertise---these make you one of the $M$ auditors for someone else's claims.
\end{enumerate}
...
\subsection{The Symmetric Equilibrium }

\begin{proposition}[All-Honest Equilibrium ]
...
\begin{remark}[The Theorem Enforces ]
...
\subsection{You Are the Auditor }
...
The ancient instruction  was wise, but incomplete. The fuller truth is:
...
\bibitem{Sanguozhi}
 (Chen Shou).
\newblock {\em  (Records of the Three Kingdoms)}, Book 32, Biography of the Former Lord ().
