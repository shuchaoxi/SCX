...
\begin{abstract}
\noindent
{\bf .} \NV{}\NV{}————\NV{}\SCX{}\NV{}stateexpert\ODMR{}RamseyHahnmulti-modal experts//state heterogeneity

\rigorFull{}
(1)~{\bf }$M$\NV{}$\Ttwo$$\exp(-2M_{\text{eff}}\,\Delta^2)$$M_{\text{eff}} = M/(1+(M-1)\bar{\rho})$
(2)~{\bf Cercis}\Cercis{}$S = Q + \eta N$$Q$$N$$M_{\text{eff}}$
(3)~{\bf $\Ttwo$}$\Ttwo$ vs  vs ——

{\bf \Cercis{}} $S = Q + \eta N$$Q$$N$CVD/HPHTN-14/N-15/\NV{}{\bf \Yajie{}}\Cercis{}$M$N-14 vs N-15$<10$~nmvs $>50$~nm\NV{}CVD vs HPHT\ODMR{}RamseyHahnXY8
...
, , , , , ,
Hoeffding, , Cercis, Yajie, ODMR, Ramsey, Hahn, .
\vspace{8pt}
...
\begin{definition}[NV Center State ]
\label{def:nv_state}
...
\begin{definition}[True Quality Parameters ]
\label{def:quality}
...
\begin{definition}[Laboratory Expert ]
\label{def:lab}
...
\begin{definition}[Measurement Protocols ]
\label{def:protocols}
...
\begin{definition}[State Heterogeneity Measure ]
...
% ════════════════════════════════════════════════════════════════════════
\section{Theorem 1: Multi-Laboratory Error Detection }
\label{sec:thm1}
% ════════════════════════════════════════════════════════════════════════

\begin{theorem}[Multi-Laboratory Systematic Error Detection Bound ]
...
\begin{corollary}[Required Number of Laboratories for Certified Auditing ]
...
\begin{corollary}[Value of Protocol Diversity ]
...
% ════════════════════════════════════════════════════════════════════════
\section{Theorem 2: Cross-Protocol \Cercis{} Score Convergence Cercis}
\label{sec:thm2}
% ════════════════════════════════════════════════════════════════════════

\begin{definition}[Coherence Time Reproducibility ]
...
\begin{definition}[Readout Fidelity Consistency ]
...
\begin{definition}[Fabrication Method Novelty ]
...
\begin{definition}[Cercis Score for NV Centers \Cercis ]
\label{def:cercis}
...
\begin{itemize}[nosep]
    ...
    \textbf{quality evidence concordance} ();
...
\begin{theorem}[Cross-Protocol \Cercis{} Score Convergence Cercis]
...
% ════════════════════════════════════════════════════════════════════════
\section{Theorem 3: $\Ttwo$ Degradation Source Unidentifiability $\Ttwo$}
\label{sec:thm3}
% ════════════════════════════════════════════════════════════════════════

\begin{theorem}[$\Ttwo$ Degradation Source Unidentifiability ]
\label{thm:unident}
\rigorFull
...
% ════════════════════════════════════════════════════════════════════════
\section{\Cercis{} Score and \Yajie{} Multi-Laboratory Consensus \Cercis Yajie}
\label{sec:cercis}
% ════════════════════════════════════════════════════════════════════════
...
\begin{definition}[Operationalized Quality Concordance ]
...
\begin{definition}[Operationalized Fabrication Novelty ]
...
\begin{definition}[\Yajie{} Multi-Laboratory Consensus ]
\label{def:yajie}
...
\begin{enumerate}[label=\textbf{B\arabic*:}, leftmargin=*]
    ...
    \item \textbf{N-14 vs N-15 Isotopic Composition (N-14N-15).}
    \begin{itemize}[nosep]
    ...
    \item \textbf{Shallow vs Deep NV Centers (NV).}
    \begin{itemize}[nosep]
    ...
    \item \textbf{CVD vs HPHT Diamond Substrates (CVDHPHT).}
    \begin{itemize}[nosep]
    ...
    \item \textbf{Cross-Protocol Measurement Comparison ().}
    \begin{itemize}[nosep]
