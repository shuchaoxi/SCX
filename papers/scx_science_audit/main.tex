...
\end{align}
Declaring $M$ and falsifying = \textbf{active evil} (作恶): actively constructing deception to defeat a known verification threshold.
\end{theorem}
...
% ===========================================================================
\section{Theorem 4 — Reviewer Complicity 审稿人同谋对等定理}
\label{sec:reviewer-complicity}
% ===========================================================================

\begin{theorem}[审稿人同谋对等定理]
...
\begin{enumerate}[label=(\roman*)]
    \item $r < r^*$: \textbf{negligent} (过失).
    \item $r \ge r^*$: \textbf{complicit} (同谋) — maintains pooling equilibrium enabling fraud.
...
\begin{corollary}[机构同谋]
Journal with M=0 acceptance rate $\alpha$ has $\mathcal{C}_{\text{venue}} = \alpha$. Accepting M=0 papers = institutional complicity.
\end{corollary}

% ===========================================================================
\section{Theorem 5 — Data Substitution Attack Infeasibility 数据替换攻击不可行定理 (羊头狗肉定理)}
\label{sec:thm5}
% ===========================================================================

\begin{theorem}[数据替换攻击不可行定理 (羊头狗肉定理)]
...
\begin{itemize}[nosep]
    ...
    \item \textbf{耿同学}: $M=1$ shifts equilibrium. $M=100$ institutionalizes.
\end{itemize}

% ===========================================================================
\section{Cercis Score for Papers 论文Cercis评分}
\label{sec:cercis}
% ===========================================================================
$\Cercis(\text{paper}) = Q + \eta N$, $Q$ = replicability, $N$ = novelty. $M=0 \implies Q \equiv 0$.

% ===========================================================================
\section{M-Parameter Arms Race + Dark Forest M参数军备竞赛与黑暗森林}
\label{sec:arms-race}
% ===========================================================================
\begin{enumerate}[label=(\roman*)]
...
\subsection{Dark Forest Protocol 黑暗森林协议}
...
% ===========================================================================
\section{M-Registry: Public Monitoring M参数公开登记网}
...
% ===========================================================================
\section{Discussion — 人类的精神结晶不允许拉屎}
