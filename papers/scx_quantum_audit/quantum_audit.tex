...
$C_Q = 1 - H_2(2p/3)$ for the depolarizing channel with noise parameter $p$,
...
\textbf{(1) \Mt\ 传输的BB84协议}（第\ref{sec:bb84}节）：我们将Bennett--Brassard 1984
...
$C_Q(0.11) \approx 0.633$ bits/qubit. The channel capacity
...
\begin{itemize}
  ...
  \item $p = 0.11$: $C_Q = 1 - H_2(0.0733) \approx 0.633$ bits/qubit.
