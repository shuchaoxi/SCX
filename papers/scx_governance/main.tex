...
\subsection{The State Space Status空间}

\begin{definition}[Governance State 治理Status]
\label{def:state}
...
\begin{assumption}[A1: Bounded State Space 有界Status空间]
\label{ass:A1}
...
\textbf{World 2 (Implementation-dominant 执行Fails主导):}
\begin{align}
...
\subsection{Expert Configuration 专家Configuration}
...
\begin{table}[htbp]
\centering
\caption{Multi-expert configurations for governance metrics 治理指标的多专家Configuration.}
...
\midrule
GDP growth GDPGrowth & National accounts 国民账户 & Electricity consumption 电力消耗 & Satellite nighttime lights 卫星夜光 & VAT/tax receipts 增值税/税收收入 \\
\midrule
