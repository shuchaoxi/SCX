...
Hearsay & Self-audit loop (Theorem~2) & 传闻 $\leftrightarrow$ Self-Audit \\
...
\begin{enumerate}[label=(\roman*)]
    ...
    \begin{itemize}
        ...
        \item \textbf{Theorem~\ref{thm:hearsay}} (Hearsay as Self-Audit 传闻Self-Audit): A hearsay claim provides zero independent corroboration and is mathematically equivalent to a self-audit loop.
...
%=====================================================================
\section{Theorem 2: Hearsay as Self-Audit 传闻证据的Self-Audit不可辨识性}
\label{sec:hearsay}
%=====================================================================

\subsection{Statement}

\begin{theorem}[Hearsay Self-Audit Unidentifiability 传闻Self-Audit不可辨识性]
\label{thm:hearsay}
...
Thm.~2 & Information laundering (hearsay) & Self-audit identification & 传闻Self-Audit \\
