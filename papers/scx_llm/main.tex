...
\subsection{SCX Alignment Equilibrium Theorem 对齐博弈均衡定理}
\label{sec:alignment}
...
\begin{theorem}[Single-Judge Insufficiency — 对齐 M=1 不可能定理]
...
\begin{proof}
By Theorem~3 (老实人定理), the observation $(a, R_1(a))$ is consistent with two indistinguishable worlds:
...
\begin{theorem}[Multi-Judge Alignment Guarantee — 对齐 M>1 必然检测定理]
