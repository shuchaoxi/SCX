...
%=====================================================================
\section{Formalization: Electoral Tabulation as Multi-Method Verification}
\label{sec:formalization}
%=====================================================================
\subsection{The Vote Count Space}
\begin{definition}[Electoral Contest ]
\label{def:contest}
...
\end{itemize}
\end{definition}
\begin{definition}[True Vote Count ]
\label{def:true_vote}
...
\end{definition}
\subsection{Counting Methods as Auditors}
\begin{definition}[Counting Method ]
\label{def:method}
...
\begin{itemize}
    \item $\method{P}$: \textbf{Paper ballot hand count} Election workers manually sort and count paper ballots. Error modes: human fatigue (miscounting), ambiguous ballot marks (voter intent interpretation), chain-of-custody lapses.
    \item $\method{E}$: \textbf{Electronic voting machine tabulation} Optical scan or DRE machines automatically tabulate votes. Error modes: software bugs, sensor miscalibration, memory errors, hacking/tampering, power failures.
    \item $\method{R}$: \textbf{Hand recount / risk-limiting audit} A statistical sample or full recount of ballots independently of the initial tabulation. Error modes: sampling error (incomplete recount), temporal degradation of ballots, procedure deviation.
\end{itemize}
\end{definition}
\begin{definition}[Method Error Characteristics ]
...
\end{definition}
\begin{definition}[Inter-Method Error Correlation ]
...
\end{definition}
\subsection{Observer Community Observers}
\begin{definition}[Observer Community Observers]
...
\end{definition}
\begin{definition}[Effective Auditor Multiplicity ]
\label{def:Meff}
...
\begin{assumption}[A1: Bounded Vote Counts ]
\label{ass:A1}
...
\end{assumption}
\begin{assumption}[A2: Counting Method Independence ]
\label{ass:A2}
...
\end{assumption}
\begin{assumption}[A3: Bounded Detection Power per Method ]
\label{ass:A3}
...
\end{equation}
\end{assumption}
\begin{assumption}[A4: Observer Independence Observers]
\label{ass:A4}
...
\end{assumption}
\begin{assumption}[A5: Positive Observer Detection Rate Observers]
\label{ass:A5}
...
\end{equation}
\end{assumption}
\begin{assumption}[A6: Unbiased Method Errors ]
\label{ass:A6}
...
\end{assumption}
\begin{assumption}[A7: Discrepancy Triggers Full Audit ]
\label{ass:A7}
...
\end{assumption}
\begin{assumption}[A8: Ballot Chain of Custody ]
\label{ass:A8}
...
\end{assumption}
\begin{assumption}[A9: Hash-Commitment Publication ]
\label{ass:A9}
...
\end{assumption}
\begin{assumption}[A10: Regime Transition Detectability ]
\label{ass:A10}
...
\end{assumption}
%=====================================================================
\section{Theorem 1: Multi-Method Consensus Detection}
\label{sec:thm1}
%=====================================================================
...
\begin{lemma}[Single-Candidate Detection Probability ]
...
\begin{theorem}[Multi-Method Consensus Detection ]
...
\end{proof}
\begin{corollary}[Required Observer Multiplicity Observers]
...
\end{remark}
%=====================================================================
\section{Theorem 2: Discrepancy Source Unidentifiability}
\label{sec:thm2}
%=====================================================================
...
\begin{definition}[Vote Count Discrepancy Decomposition ]
...
\begin{theorem}[Discrepancy Source Unidentifiability ]
...
\textbf{World 1 (Paper human error}
\begin{align}
...
\textbf{World 2 (Electronic machine error}
\begin{align}
...
\textbf{World 3 (Recount sampling error}
\begin{align}
...
\textbf{World 4 (Ballot tampering between counts}
\begin{align}
...
\end{proof}
\begin{corollary}[Assumption Mandate for Electoral Discrepancy Investigation ]
...
\end{remark}
%=====================================================================
\section{Theorem 3: Observer Community Detection Power Observers}
\label{sec:thm3}
%=====================================================================
...
\begin{definition}[Result Certification ]
...
\end{definition}
\begin{definition}[Observer Detection Event Observers]
...
\end{definition}
\subsection{Theorem Statement and Proof}
\begin{theorem}[Observer Community Detection Power Observers]
...
\end{proof}
\begin{corollary}[Minimum Observer Count for VERIFIED Certification Observers]
...
\end{corollary}
%=====================================================================
\section{Multi-Method \Yajie{} Certification Protocol Yajie}
\label{sec:protocol}
%=====================================================================
...
\subsection{\Yajie{} Consensus for Vote Tabulation Yajie}
...
\end{definition}
\begin{definition}[\\Yajie{} Consensus Vote Count \\Yajie{}]
...
\caption{\Yajie{} Multi-Method Vote Certification Protocol }
...
\State \textbf{Phase 1: Independent Counting}
\For{$m \in \{P, E, R\}$}
...
\EndFor
\State \textbf{Phase 2: Consensus Computation}
...
\EndIf
\State \textbf{Phase 3: Observer Verification Observers}
\For{$j = 1$ to $K$}
...
\EndIf
\State \textbf{Phase 4: Publication}
...
\end{algorithmic}
\end{algorithm}
\begin{proposition}[Protocol Soundness ]
...
\end{proof}
%=====================================================================
\section{\Cercis{} Electoral Integrity Score Cercis}
\label{sec:cercis}
%=====================================================================
...
\begin{definition}[Electoral Quality Score ]
...
\end{definition}
\begin{definition}[Electoral Novelty Score ]
...
\end{definition}
\begin{definition}[\\Cercis{} Electoral Integrity Score \\Cercis{}]
...
\begin{table}[htbp]
\centering
\caption{Illustrative \Cercis{} scores for electoral systems CercisExample. $\eta = 0.3$.}
\label{tab:cercis_electoral}
\begin{tabular}{lcccccc}
\toprule
Electoral System  & $\varepsilon_{\text{cons}}$ & $\varepsilon_{\text{fc}}$ & $\varepsilon_{\text{fa}}$ & $Q$ & $N$ & $S$ \\
\midrule
Paper-only, no audit  & 0.015 & 0.020 & 0.000 & $-0.035$ & 0.00 & $-0.035$ \\
Paper + electronic, no recount + & 0.008 & 0.010 & 0.005 & $-0.023$ & 0.20 & $-0.017$ \\
Full SCX protocol ($M=3$) SCX & 0.002 & 0.001 & 0.010 & $-0.013$ & 0.60 & $+0.005$ \\
SCX + observers ($K=50$) SCX+Observers & 0.001 & 0.000 & 0.008 & $-0.009$ & 0.85 & $+0.017$ \\
\bottomrule
\end{tabular}
\end{table}
...
\end{remark}
%=====================================================================
\section{\Spring{} Gating for Electoral Irregularity Detection Spring}
\label{sec:spring}
%=====================================================================
...
\begin{definition}[Electoral Regime ]
...
\end{definition}
\begin{definition}[\\Spring{} Electoral Detection Statistic \\Spring{}]
...
\end{equation}
\end{definition}
\begin{proposition}[\\Spring{} Detection Properties for Elections \\Spring{}]
...
%=====================================================================
\subsection{Precinct-Level Tabulation}
...
\subsection{Mail-In Ballot Processing}
...
\subsection{Multi-Jurisdiction Result Aggregation}
...
\begin{table}[htbp]
\centering
\caption{Multi-jurisdiction detection power as a function of irregular precinct count}} = 0.01$.}
...
\end{tabular}
\end{table}
\subsection{Observer Access as a Continuous Variable Observers}
...
\begin{enumerate}[label=\textbf{Tier \arabic*}:, leftmargin=*]
    \item \textbf{Full access} ($\gamma = 1.0$): Observers witness all three counting methods, compare outputs in real time, and independently record hash commitments. This is the gold standard for international election observation missions.
    \item \textbf{Partial access} ($\gamma = 0.5$): Observers witness two methods (typically paper count and electronic tabulation, but not the recount). Detection rate $\alpha_{\min} \approx 2\alpha_{\min}^{(0)}/3$.
    \item \textbf{Limited access} ($\gamma = 0.2$): Observers witness only one method, typically the paper ballot count. Detection rate $\alpha_{\min} \approx \alpha_{\min}^{(0)}/3$. This is the minimum for any verification benefit; observing zero methods provides $\gamma = 0$, contributing nothing to $M_{\text{eff}}^{\text{total}}$.
\end{enumerate}
...
%=====================================================================
\subsection{Relationship to Existing Electoral Integrity Frameworks}
