...
\author{SCX Research Collective --- Matrix Theory Division\\[4pt]
        \small 孝感超算中心 / Xiaogan Supercomputing Center}
...
% ===========================================================================
\section{Unified Proof Architecture 统一证明架构}
\label{sec:unified_proofs}
% ===========================================================================

\subsection{The Common Proof Template 通用证明模板}
...
\subsection{Proof of Universality 普遍性证明}
...
\subsection{The Concentration Inequality Catalog 浓度不等式目录}
