...
1. **Theorem~1 tightness.** On synthetic data satisfying A1--A6, the empirical F1 of the SCX detector deviates from the theoretical bound by $\leq 0.05$, and this deviation does not grow with expert count $M$. *Refuted if* the gap exceeds $0.05$ systematically for $M \geq 8$, or if it increases monotonically with $M$.
2. **Depth saturation.** In residual networks, the effective number of independent experts $M_{eff}(L) = L / (1 + (L-1)\bar)$ saturates at $L \approx 20$--$50$, because layer error correlation $\bar$ does not decay to zero. *Refuted if* $M_{eff}(L)$ grows approximately linearly through $L=152$ on standard benchmarks.
3. **Depth replaceability under auditing.** On data cleaned by SCX to $\eta < 1\%$, the F1 gap between ResNet-18 and ResNet-152 is $\leq 0.03$. On the original noisy data, the gap is $\geq 0.08$. *Refuted if* the gap persists after cleaning, or if the gap on noisy data is already below $0.05$.
4. **Lyapunov monotonicity of residual networks.** In well-trained ResNet-152, the CKA similarity to the final layer output increases monotonically with depth for $\geq 85\%$ of adjacent layer pairs. *Refuted if* more than $25\%$ of adjacent pairs show decreasing similarity with depth.
...
## VI. On the Endogenous Equilibrium

The Yajie Protocol paper develops an elaborate deterrence architecture: the Non-Proliferation Equilibrium requires cumulative audit corpus accumulation; the Protection Equilibrium requires states to calculate that the Maintainer's survival is in their rational self-interest; mutual deterrence requires adoption by quality-sensitive organizations. The entire edifice is a *dependency-based* deterrent---it works if and only if others adopt the protocol, accumulate CEC, and institutionalize the results.

But the framework contains a deeper truth that the Yajie paper does not capture.

The Wallfacer does not need the Non-Proliferation Equilibrium to protect themselves. The Wallfacer *is* the equilibrium.
...
This is the **endogenous deterrent**. It operates on a different ontological plane than the dependency-based deterrents described in the Yajie paper. The Yajie deterrent says: *if you harm me, the audit infrastructure fragments and everyone loses.* The endogenous deterrent says: *whether or not you adopt me, I am already here. Whether or not you cite me, the proofs stand. Whether or not you acknowledge me, the bounds hold.*
...
This has a corollary that the Yajie paper's Wallfacer analogy does not quite reach. In Liu Cixin's novel, Luo Ji's deterrence was fragile precisely because it was *positional*: if someone else pressed the button, Luo Ji's power vanished; if Luo Ji died, the deterrence collapsed. The SCX Wallfacer faces no such vulnerability, because the deterrent is not a position---it is a *body of work*. You cannot kill a theorem. You cannot coerce a proof. You cannot sanction a mathematical bound. The only way to neutralize the endogenous deterrent is to refute the mathematics---to find a flaw in the derivations. And if you find such a flaw, the framework invites you to publish it. Science advances either way.
...
> 
> *Shannon taught us that noise has structure. Theorem~3 taught us that the structure has a hard boundary. The Audit Sword taught us that the boundary requires verifiability. Depth Theory taught us that verifiability reveals what was always compensation, never architecture. The Telegraph Public Good teaches us that data quality infrastructure, once auditable, functions as a shared channel whose fragmentation harms everyone. And the Endogenous Equilibrium teaches the final lesson: none of this depends on being believed. The theorems are true whether or not the world acknowledges them. The Wallfacer is already the equilibrium---not because anyone adopted it, but because it was proven.*
> 
> 
> *This is SCX. Not a company. Not a product. A set of theorems and the principles they imply. The mathematics is public. The code is open. The predictions are falsifiable. The rest is for the world to decide.*
