...
%  SCXPerspective：对机器学习历史的Theorem-by-Theorem Re-Audit
...
\title{\textbf{The SCX Lens:}\\[4pt]
       ...
       \normalsize \textbf{SCXPerspective：对机器学习历史的Theorem-by-Theorem Re-Audit}}
\author{SCX}
\date{June 2026}
...
\section{引言——透过SCXPerspective看机器学习史}
\label{sec:intro}
% ===========================================================================
...
\section{Ensemble Methods as定理1——Explicit Multi-Expert Consensus}
\label{sec:ensemble}
% ===========================================================================
...
\section{Dropout作为Implicit Multi-Expert——$2^n$个Sub-Network Voting}
\label{sec:dropout}
% ===========================================================================
...
\section{ResNet与Depth as Noise Compensation}
\label{sec:resnet}
% ===========================================================================
...
\section{GANs as Adversarial Audit——及Why$M=1$Fails}
\label{sec:gans}
% ===========================================================================
...
\section{Self-Supervised Learning as Self-Audit——定理2的Domain of Applicability}
\label{sec:ssl}
% ===========================================================================
...
SCXPerspective揭示：机器学习史从来不只是工程实践。\\
