...
\begin{theorem}[[ZH]CEC[ZH]]
\label{thm:asymptotic-uniqueness}
[ZH]A1--A7[ZH]：

\begin{enumerate}[label=(\roman*)]
\item [ZH]\textbf{CEC[ZH]} $|\mathcal{E}|^*$，[ZH]：
\begin{equation}
|\mathcal{E}|^* \triangleq \inf\left\{|\mathcal{E}| \geq 0 : \Delta(|\mathcal{E}|) \geq \lambda - \kappa\right\}
\label{eq:E-star}
\end{equation}
[ZH] $\Delta(0) \geq \lambda - \kappa$，[ZH] $|\mathcal{E}|^* = 0$（[ZH]）。[ZH]，[ZH] $\theta(\cdot)$ [ZH] $V(\cdot)$ [ZH]，$|\mathcal{E}|^*$ [ZH]。

\item [ZH] $|\mathcal{E}| > |\mathcal{E}|^*$，$s^* = (A, \ldots, A)$ [ZH] $\Gamma^{\text{NP}}$ [ZH]\textbf{[ZH]}[ZH]——[ZH]，[ZH]。

\item CEC[ZH]：
\begin{equation}
|\mathcal{E}|^* = \frac{1}{\gamma} \ln \left( \frac{\theta_{\max} - \theta_0}{\theta_{\max} - \theta^*} \right)
\end{equation}
[ZH] $\theta^* = V^{-1}\left(V[\theta(0)] + c^{\text{adopt}} - c^{\text{develop}} - \kappa + \lambda - \kappa\right)$，$V^{-1}$ [ZH] $V$ [ZH]（[ZH]A1[ZH]）。
\end{enumerate}
\end{theorem}

\begin{proof}
\textbf{(i)} [ZH] $\Delta(|\mathcal{E}|)$ [ZH] $[0, \infty)$ [ZH]（A1--A2[ZH] $V \circ \theta$ [ZH]）[ZH]：
\begin{equation}
...
\end{equation}
[ZH] $V' > 0$（A1）[ZH] $\theta' > 0$（A2）。[ZH]$\inf$[ZH]。

\textbf{(ii)} [ZH] $|\mathcal{E}| > |\mathcal{E}|^*$，[ZH] $\Delta(|\mathcal{E}|) > \lambda - \kappa$（[ZH]）。[ZH]\ref{thm:npe-complete}[ZH](ii)[ZH] $(A, \ldots, A)$ [ZH]。[ZH] $\Delta(|\mathcal{E}|) \leq -(n-1)\kappa$ [ZH]（[ZH] $\Delta(|\mathcal{E}|) > \lambda - \kappa > 0 > -(n-1)\kappa$，[ZH]A4 $\lambda > \kappa > 0$）。[ZH]，[ZH]，[ZH]。[ZH] $(A, \ldots, A)$ [ZH]。

\textbf{(iii)} [ZH] $\Delta(|\mathcal{E}|) = \lambda - \kappa$ [ZH] $\theta^*$，[ZH]A2[ZH]。
\end{proof}

\begin{corollary}[[ZH]]
\label{cor:self-reinforcing}
[ZH]A1--A7[ZH]，[ZH]\textbf{[ZH]}：
\begin{equation}
M(|\mathcal{E}|) \triangleq \Delta(|\mathcal{E}|) - (\lambda - \kappa)
\end{equation}
[ZH]：
\begin{enumerate}[label=(\roman*)]
\item $M(|\mathcal{E}|)$ [ZH] $[0, \infty)$ [ZH]：$M'(|\mathcal{E}|) = V'[\theta(|\mathcal{E}|)] \cdot \theta'(|\mathcal{E}|) > 0$；
\item $\lim_{|\mathcal{E}| \to \infty} M(|\mathcal{E}|) = V(\theta_{\max}) - V(\theta_0) + c^{\text{develop}} - c^{\text{adopt}} + \kappa - \lambda$；
\item [ZH] $\Delta |\mathcal{E}| > 0$ [ZH]CEC，[ZH]：(a) [ZH]（$\partial u_i(A, \cdot) / \partial |\mathcal{E}| > 0$），(b) [ZH]（$M(|\mathcal{E}|)$ [ZH]），(c) [ZH] $p^*$ [ZH]（[ZH]）。
\item [ZH]——[ZH]——[ZH]\textit{[ZH]}[ZH]。
\end{enumerate}
\end{corollary}

\begin{proof}
[ZH]\ref{thm:npe-complete}[ZH]\ref{thm:asymptotic-uniqueness}[ZH]A1--A2[ZH]。
\end{proof}

\begin{corollary}[[ZH] (Temporal Decay of First-Mover Advantage)]
\label{cor:first-mover-decay}
[ZH]A1--A7[ZH]。[ZH]：

\begin{definition}[[ZH]]
[ZH]（CEC[ZH] $|\mathcal{E}|$）[ZH]CEC[ZH]\textbf{[ZH]}[ZH]：
\begin{equation}
...
\begin{enumerate}[label=(\roman*), itemsep=6pt]
\item \textbf{[ZH]：} [ZH] $\delta(|\mathcal{E}|)$ [ZH]（$\delta'(|\mathcal{E}|) = \gamma(\theta_{\max} - \theta_0)e^{-\gamma |\mathcal{E}|} > 0$），[ZH]\textit{[ZH]}[ZH]：
\begin{equation}
...
\end{equation}
\textbf{[ZH]：[ZH]——CEC[ZH]（[ZH]）。[ZH]，[ZH]，[ZH] $\theta_{\max} - \theta_0$。}

\item \textbf{[ZH]：} [ZH] $\delta(|\mathcal{E}|)$ [ZH] $\Delta(|\mathcal{E}|)$ [ZH]（[ZH]\ref{eq:adoption-advantage-def}）：
\begin{equation}
\Delta(|\mathcal{E}|) = V[\theta_0 + \delta(|\mathcal{E}|)] - V[\theta_0] - (c^{\text{adopt}} - c^{\text{develop}}) + \kappa
\end{equation}
[ZH]A1（$V$ [ZH]），$\Delta'(|\mathcal{E}|) = V'[\theta(|\mathcal{E}|)] \cdot \delta'(|\mathcal{E}|) > 0$ [ZH] $\Delta''(|\mathcal{E}|) < 0$。[ZH]（$\delta' \to 0$）[ZH]（$V' \to 0$ [ZH] $\theta \to \theta_{\max}$）。[ZH]：
\begin{equation}
\lim_{|\mathcal{E}| \to \infty} \Delta'(|\mathcal{E}|) = 0
\end{equation}
\textbf{[ZH]：[ZH]CEC[ZH]——[ZH]。}

\item \textbf{CEC[ZH]（[ZH]）：} CEC[ZH]\textit{[ZH]}（additive public good）：(a) \textbf{[ZH]}——[ZH]CEC[ZH]（$\Delta |\mathcal{E}| > 0$），CEC[ZH]（[ZH]M4）；(b) \textbf{[ZH]}——CEC[ZH]、[ZH]\textit{[ZH]}[ZH]：[ZH] $i$ [ZH] $j$ [ZH]。

[ZH]CEC[ZH] $T^*$ [ZH]——[ZH]（[ZH]6[ZH]1[ZH]IDAA）。[ZH] $t > T^*$，[ZH] $|\mathcal{E}_t^{\text{public}}|$ [ZH]CEC[ZH]。[ZH] $\theta(|\mathcal{E}_t|) - \theta(0)$ [ZH] $\theta(|\mathcal{E}_t|) - \theta(|\mathcal{E}_t^{\text{public}}|)$。[ZH]\textbf{[ZH]}：
\begin{equation}
\Psi(t; T^*) \triangleq \frac{\theta(|\mathcal{E}_t|) - \theta(|\mathcal{E}_t^{\text{public}}|)}{\theta(|\mathcal{E}_t|) - \theta(0)} \in [0, 1]
\end{equation}
$\Psi(T^*; T^*) = 1$（[ZH]，[ZH]CEC[ZH]，[ZH]）。[ZH] $|\mathcal{E}_t^{\text{public}}| \to |\mathcal{E}_t|$（[ZH]CEC[ZH]CEC），$\Psi \to 0$。[ZH]（$|\mathcal{E}_t^{\text{public}}| = |\mathcal{E}_t|$），$\Psi \equiv 0$——[ZH]。

[ZH]，[ZH]。[ZH]\textit{[ZH]}[ZH]：(a) \textbf{[ZH]}——[ZH]、[ZH]（[ZH]\ref{thm:absorption}[ZH]）；(b) \textbf{[ZH]}——CEC[ZH]，[ZH]。

\item \textbf{[ZH]：} [ZH]\textbf{[ZH]} $T_{1/2}^{\Delta}$ [ZH]：
\begin{equation}
\Delta(|\mathcal{E}_{T_{1/2}^{\Delta}}|) - (\lambda - \kappa) = \frac{1}{2}\left[\Delta(|\mathcal{E}_{T^*}|) - (\lambda - \kappa)\right]
\end{equation}
[ZH]NPE[ZH]（[ZH]\ref{cor:self-reinforcing}）[ZH]。[ZH]A2[ZH]，$T_{1/2}^{\Delta}$ [ZH]：
\begin{equation}
...
\end{equation}
[ZH] $V \circ \theta$ [ZH] $\Delta(\cdot)$ [ZH]。[ZH]：\textbf{[ZH]，[ZH]。}

\item \textbf{[ZH]——NPE[ZH]：} [ZH]\ref{thm:npe-complete}[ZH]\ref{cor:self-reinforcing}[ZH]"[ZH]CEC[ZH]"[ZH]，[ZH]CEC[ZH]，[ZH]：NPE[ZH]CEC[ZH]\textit{[ZH]}[ZH]。[ZH]CEC[ZH]（[ZH]IDAA[ZH]），[ZH] $\Delta(|\mathcal{E}|)$ [ZH]——[ZH] $\theta(|\mathcal{E}_t^{\text{private}}|) - \theta(|\mathcal{E}_t^{\text{public}}|)$ [ZH]——[ZH]。[ZH]，[ZH]"[ZH]"[ZH]"[ZH]"——[ZH]CEC[ZH]，[ZH] $\lambda$ [ZH]，[ZH]CEC[ZH]CEC[ZH]。

[ZH]，NPE[ZH]\textit{[ZH]}[ZH]\textit{[ZH]}[ZH]。[ZH] $\Delta(|\mathcal{E}^{\text{private}}|) \geq \lambda - \kappa$ [ZH]（[ZH]NPE）；[ZH] $\Delta(|\mathcal{E}^{\text{public}}|) \geq \lambda - \kappa$ [ZH]（[ZH]NPE），[ZH] $\Delta(|\mathcal{E}^{\text{public}}|)$ [ZH]——[ZH]，[ZH]CEC[ZH]（[ZH]）。

\textbf{[ZH]"[ZH]"[ZH]——[ZH]5.2.2[ZH]。}
\end{enumerate}
\end{corollary}

\begin{proof}
\textbf{(i)--(ii)} [ZH]。[ZH]A2，$\theta'(|\mathcal{E}|) = \gamma(\theta_{\max} - \theta_0)e^{-\gamma |\mathcal{E}|} > 0$，$\theta''(|\mathcal{E}|) = -\gamma^2(\theta_{\max} - \theta_0)e^{-\gamma |\mathcal{E}|} < 0$。[ZH] $\delta'(|\mathcal{E}|) > 0$，$\delta''(|\mathcal{E}|) < 0$，[ZH] $\delta'(|\mathcal{E}|) \to 0$ [ZH] $|\mathcal{E}| \to \infty$。$\lim_{|\mathcal{E}| \to \infty} \delta(|\mathcal{E}|) = \theta_{\max} - \theta_0$ [ZH]。$\Delta(|\mathcal{E}|)$ [ZH] $V$ [ZH]（A1）[ZH] $\delta(|\mathcal{E}|)$ [ZH]。

\textbf{(iii)} CEC[ZH]：[ZH]——[ZH]，[ZH]。[ZH]CEC[ZH]（[ZH](2)）[ZH]——$\mathcal{E}_t = \bigcup_{\tau=0}^{t} \{\cdots\}$，[ZH]。[ZH] $\Psi(t; T^*)$ [ZH]：[ZH] $|\mathcal{E}_t^{\text{public}}| \to |\mathcal{E}_t|$，[ZH] $\theta$ [ZH]，$\theta(|\mathcal{E}_t^{\text{public}}|) \to \theta(|\mathcal{E}_t|)$，[ZH] $\Psi \to 0$。[ZH]\ref{thm:absorption}（[ZH]，[ZH]M3）[ZH]（CEC[ZH]）[ZH]。

\textbf{(iv)} [ZH]：[ZH] $f(t) = \Delta(|\mathcal{E}_t|) - (\lambda - \kappa)$ [ZH] $[T^*, \infty)$ [ZH]（A1--A2[ZH]）、[ZH]（[ZH] $\lim_{|\mathcal{E}| \to \infty} \Delta(|\mathcal{E}|)$ [ZH] $\lambda - \kappa$ [ZH]）。[ZH] $\frac{1}{2}[\Delta(|\mathcal{E}_{T^*}|) - (\lambda - \kappa)]$，[ZH]（[ZH]）。[ZH]，[ZH]——$f(t)$ [ZH]。[ZH] $\Delta(|\mathcal{E}|) \equiv \text{const}$（[ZH] $V$ [ZH] $\theta$ [ZH]，[ZH]A1--A2[ZH]），[ZH]。

\textbf{(v)} NPE[ZH]：[ZH](\ref{eq:all-adopt-condition})[ZH] $\Delta(|\mathcal{E}|)$ [ZH]CEC[ZH]。[ZH]，$\Delta(|\mathcal{E}|) = \Delta(|\mathcal{E}^{\text{private}}|)$；[ZH]，[ZH] $\Delta(|\mathcal{E}^{\text{public}}|)$。[ZH] $\Delta(|\mathcal{E}^{\text{public}}|) \geq \lambda - \kappa$ [ZH]——[ZH]。
\end{proof}

\begin{remark}[[ZH]]
[ZH]\ref{cor:first-mover-decay}[ZH]NPT[ZH]（[ZH]3.5[ZH]）[ZH]。NPT[ZH]VI[ZH]"[ZH]"[ZH]——[ZH]。[ZH]，CEC[ZH]"[ZH]VI[ZH]"：[ZH]CEC[ZH]，[ZH]。[ZH]NPT[ZH]（Joyner, 2011），CEC[ZH]——[ZH] $S_3$（[ZH]）[ZH]（[ZH]\ref{prop:intervention-window}[ZH]）。
\end{remark}
...
A key result emerges: the stability of the non-proliferation equilibrium is \textit{monotonically increasing} in $|\mathcal{E}|$, because $\Delta_A$ grows without bound (up to its asymptotic ceiling) while $\lambda - \kappa$ is fixed. There exists a critical CEC size $|\mathcal{E}|^*$ such that for all $|\mathcal{E}| > |\mathcal{E}|^*$, $(A, A, \ldots, A)$ is the unique Nash equilibrium. This uniqueness is underwritten by Theorem~4 ([ZH]): no alternative algorithm can surpass SCX's minimax-optimal detection rate. The ceiling is absolute.
\begin{equation}
...
\subsubsection{IASB[ZH]}

IASB[ZH]，[ZH]。

\begin{definition}[IASB[ZH]]
$N = \{1, \ldots, n\}$ [ZH] $\sigma \in [0,1]$ [ZH]。[ZH] $i$ [ZH] $u_i(\sigma) = -|\sigma - \sigma_i^*|$（[ZH]），[ZH] $\sigma_i^* \in [0,1]$ [ZH] $i$ [ZH]。[ZH]IASB[ZH]，[ZH] $m$ [ZH]（$m$ [ZH]），[ZH]。
\end{definition}

\begin{definition}[IASB[ZH]]
\label{def:iasb-assumptions}
\begin{enumerate}[label=\textbf{I\arabic*}, leftmargin=*, itemsep=4pt]
\item \textbf{[ZH]：} [ZH] $i$ [ZH] $[0, \sigma_i^*]$ [ZH]，[ZH] $[\sigma_i^*, 1]$ [ZH]。[ZH]。\hfill\textit{[ZH]：[ZH]，[ZH]。}

\item \textbf{[ZH]：} [ZH]（[ZH]"[ZH]"[ZH]"[ZH]"）。\hfill\textit{[ZH]：[ZH]，[ZH]。}

\item \textbf{[ZH]：} [ZH]，[ZH]（sincere）。[ZH]，[ZH] $\sigma^*$ [ZH]。\hfill\textit{[ZH]：[ZH]+[ZH]$\implies$[ZH]（Black, 1948）。}

\item \textbf{[ZH]：} [ZH] $i$ [ZH] $w_i$ [ZH]，$\sum_i w_i = m$。$w_i$ [ZH]IFRS[ZH]、[ZH]。[ZH]——[ZH]。
\end{enumerate}
\end{definition}

\begin{proposition}[IASB[ZH]]
\label{prop:iasb-bias}
[ZH]I1--I4[ZH]，IASB[ZH] $\sigma^{\text{IASB}}$ [ZH]。[ZH] $i$ [ZH]：
\begin{equation}
L_i^{\text{IASB}} = -|\sigma^{\text{IASB}} - \sigma_i^*|
\end{equation}

[ZH]"[ZH]"（[ZH] $\sum_i \lambda_i u_i(\sigma)$ [ZH] $\sigma$，[ZH] $\lambda_i$ [ZH] $i$ [ZH]）[ZH]：
\begin{enumerate}[label=(\roman*)]
\item \textbf{[ZH]：} [ZH]（[ZH]），[ZH] $\sigma^{\text{IASB}}$ [ZH]。
\item \textbf{[ZH]：} [ZH] $w_i$ [ZH]，[ZH]。
\item \textbf{[ZH]：} IASB[ZH]（Zhang \& Andrew, 2014），[ZH]，[ZH]。
\end{enumerate}
\end{proposition}

\begin{proof}
[ZH]I3（[ZH]+[ZH]+[ZH]）[ZH]，Black[ZH]：[ZH]Condorcet[ZH]。[ZH]I4[ZH]，[ZH]：$\sigma^{\text{IASB}} = \min\{\sigma : \sum_{i: \sigma_i^* \leq \sigma} w_i \geq m/2\}$。[ZH] $\sigma^{\text{global}}$ [ZH] $\lambda_i$ [ZH]：$\sigma^{\text{global}} = \min\{\sigma : \sum_{i: \sigma_i^* \leq \sigma} \lambda_i \geq (\sum_i \lambda_i)/2\}$。[ZH] $w_i$ [ZH] $\lambda_i$ [ZH]。
\end{proof}

\begin{remark}[[ZH]]
[ZH]\ref{prop:iasb-bias}[ZH]：[ZH]（[ZH]"[ZH]"[ZH]）[ZH]，[ZH]。[ZH]IASB[ZH]（[ZH]），[ZH]（[ZH]，[ZH]）。[ZH]（[ZH]IASB[ZH]）[ZH]：(a) [ZH]；(b) [ZH]（super-majority）[ZH]；(c) [ZH]——[ZH]，[ZH]，[ZH]。
\end{remark}
...
\begin{corollary}[[ZH] (The Good Leader's Protection Obligation)]
...
[ZH] $\mathcal{S} = \{S_1, S_2, S_3, S_4, S_5\}$：
\begin{itemize}[itemsep=2pt]
\item $S_1$：\textbf{[ZH]}（Emergence）——[ZH]，CEC[ZH]（$|\mathcal{E}| = 0$），[ZH] $\theta = \theta_0$，[ZH]；
\item $S_2$：\textbf{[ZH]}（Critical Mass）——$|\mathcal{E}| \geq |\mathcal{E}|^*$，[ZH]（$\theta(t) - \theta_0 \geq \varepsilon_\theta$），[ZH]；
\item $S_3$：\textbf{[ZH]}（Moat Formation）——$\Delta(|\mathcal{E}|) \geq \lambda - \kappa$ [ZH]，NPE[ZH]（[ZH]\ref{thm:asymptotic-uniqueness}），[ZH]；
\item $S_4$：\textbf{[ZH]}（Institutionalization）——[ZH] $\geq 2$ [ZH]/[ZH]，[ZH]"Yajie[ZH]"[ZH]；
\item $S_5$：\textbf{[ZH]}（Epistemic Closure）——[ZH]，[ZH]。[ZH]。
\end{itemize}
\end{definition}
...
\item \textbf{[ZH]：} [ZH] $t = 0, 1, 2, \ldots$ [ZH] $\mathcal{S}$ [ZH]。[ZH]（audit cycle）。\hfill\textit{[ZH]：[ZH]。}

\item \textbf{[ZH]：} [ZH] $X_{t+1}$ [ZH] $X_t$ [ZH]CEC[ZH] $|\mathcal{E}_t|$：
\begin{equation}
\mathbb{P}[X_{t+1} = S_j \mid X_t = S_i, |\mathcal{E}_t|, \mathcal{H}_{t-1}] = \mathbb{P}[X_{t+1} = S_j \mid X_t = S_i, |\mathcal{E}_t|]
\end{equation}
[ZH] $\mathcal{H}_{t-1}$ [ZH] $t-1$ [ZH]。\hfill\textit{[ZH]：[ZH]CEC[ZH]。[ZH]CEC[ZH]，[ZH]，[ZH]。}

\item \textbf{[ZH]（[ZH]）：} $p_{ij}(|\mathcal{E}|) = 0$ [ZH] $j < i$ [ZH]。[ZH]，[ZH]。\hfill\textit{[ZH]：[ZH]（[ZH]QWERTY[ZH]、TCP/IP[ZH]）。[ZH]，[ZH]（[ZH]）[ZH]。[ZH]。}

\item \textbf{CEC[ZH]：} $|\mathcal{E}_t|$ [ZH] $t$ [ZH]：$|\mathcal{E}_{t+1}| \geq |\mathcal{E}_t|$ [ZH] $t$ [ZH]。\hfill\textit{[ZH]：CEC[ZH]——[ZH]（[ZH]2.1[ZH]）。}

\item \textbf{[ZH]：} $S_5$ [ZH]：$p_{55}(|\mathcal{E}|) = 1$ [ZH] $|\mathcal{E}|$。[ZH]，[ZH]。\hfill\textit{[ZH]：[ZH]——[ZH]，[ZH]（unintelligible）。}
\end{enumerate}
\end{definition}
...
[ZH] $i \in \{1,2,3,4\}$，[ZH]1：$\sum_{j=i}^5 p_{ij}(|\mathcal{E}|) = 1$。[ZH]CEC[ZH]：

\begin{itemize}[itemsep=4pt]
\item \textbf{$S_1 \to S_2$（[ZH]）：} [ZH]CEC[ZH] $|\mathcal{E}|^*$ [ZH]，[ZH]：
\begin{equation}
p_{12}(|\mathcal{E}|) = \frac{1}{1 + e^{-\alpha (|\mathcal{E}| - |\mathcal{E}|^*)}}
\label{eq:p12}
\end{equation}
[ZH] $\alpha > 0$ [ZH]。$|\mathcal{E}| \gg |\mathcal{E}|^*$ [ZH] $p_{12} \to 1$。

\item \textbf{$S_2 \to S_3$（[ZH]）：} [ZH]——[ZH] $\Delta(|\mathcal{E}|)$ [ZH] $\lambda - \kappa$ [ZH]：
\begin{equation}
p_{23}(|\mathcal{E}|) = \frac{1}{1 + e^{-\beta [\Delta(|\mathcal{E}|) - (\lambda - \kappa)]}}
\label{eq:p23}
\end{equation}
[ZH] $\beta > 0$。[ZH]\ref{thm:npe-complete}[ZH]。

\item \textbf{$S_3 \to S_4$（[ZH]）：} [ZH] $R(t)$ [ZH] $t$ [ZH]/[ZH]。[ZH] $R^*$：
\begin{equation}
...
\item \textbf{$S_4 \to S_5$（[ZH]）：} [ZH] $T_4(t)$ [ZH] $S_4$ [ZH]（[ZH]）。[ZH]：
\begin{equation}
p_{45}(|\mathcal{E}|) = 1 - e^{-\eta \cdot T_4(t)}
\label{eq:p45}
\end{equation}
[ZH] $\eta > 0$。[ZH]"[ZH]"[ZH]：[ZH]，[ZH]——[ZH]。

\item \textbf{[ZH]：} $p_{ii}(|\mathcal{E}|) = 1 - \sum_{j=i+1}^{5} p_{ij}(|\mathcal{E}|)$ [ZH] $i \in \{1,2,3,4\}$。
\end{itemize}
...
[ZH]M1--M5[ZH]：
\begin{enumerate}[label=(\roman*), itemsep=6pt]
\item \textbf{[ZH]：} [ZH] $X_0 = S_i$（$i \in \{1, \ldots, 4\}$）[ZH]，[ZH] $\{X_t\}_{t \geq 0}$ [ZH]1[ZH] $S_5$：
\begin{equation}
\mathbb{P}\left[\exists t < \infty : X_t = S_5 \mid X_0 = S_i\right] = 1
\end{equation}

\item \textbf{[ZH]：} [ZH] $S_1$ [ZH]：
\begin{equation}
\mathbb{E}[T_{\text{absorb}} \mid X_0 = S_1] = \sum_{i=1}^{4} \mathbb{E}[\tau_i]
\end{equation}
[ZH] $\tau_i$ [ZH] $i$ [ZH]（[ZH]）。$\tau_i$ [ZH]：
\begin{equation}
\mathbb{E}[\tau_i] \leq \frac{1}{\inf_{t \geq 0} \; (1 - p_{ii}(|\mathcal{E}_t|))}
\end{equation}

\item \textbf{CEC[ZH]：} [ZH] $\rho$（[ZH]）。[ZH]（[ZH]）[ZH] $\mathbb{E}[T_{\text{absorb}}] / \rho$。[ZH] $\rho$（[ZH]）[ZH]。

\item \textbf{[ZH]：}
\begin{itemize}
\item $\partial \mathbb{E}[\tau_1] / \partial |\mathcal{E}|^* < 0$：[ZH]CEC[ZH]，$S_1$ [ZH]；
\item $\partial \mathbb{E}[\tau_2] / \partial \beta < 0$：[ZH]，$S_2$ [ZH]；
\item $\partial \mathbb{E}[\tau_3] / \partial R^* < 0$：[ZH]，$S_3$ [ZH]。
\end{itemize}
\end{enumerate}
\end{theorem}

\begin{proof}
\textbf{(i)} [ZH] $i \in \{1,2,3,4\}$，[ZH]CEC[ZH]（M4），$|\mathcal{E}_t| \to \infty$ [ZH] $t \to \infty$（[ZH]）。[ZH]，$p_{i,i+1}(|\mathcal{E}_t|) \to 1$（[ZH](\ref{eq:p12})--(\ref{eq:p45})[ZH]），[ZH] $p_{ii}(|\mathcal{E}_t|) \to 0$。[ZH] $i$ [ZH] $\tau_i$ [ZH]1[ZH]，[ZH] $\mathbb{P}[\tau_i < \infty] = 1$。[ZH]，[ZH]1[ZH]。

\textbf{(ii)} [ZH] $T_i$ [ZH] $S_i$ [ZH]。[ZH]（M2）：
\begin{align}
...
\end{equation}
[ZH] $T_5 = 0$（[ZH]），[ZH] $i=1$ [ZH]。[ZH] $\mathbb{E}[\tau_i]$ [ZH] $\frac{1}{1 - p_{ii}(|\mathcal{E}_t|)}$ [ZH] $p_{ii}$ [ZH]（[ZH]）。[ZH]，[ZH]。

\textbf{(iii)} [ZH] $= T_{\text{absorb}} / \rho$。$\rho$ [ZH]。

\textbf{(iv)} [ZH](\ref{eq:p12})--(\ref{eq:p34})[ZH]。
\end{proof}

\begin{remark}[[ZH]]
[ZH]\ref{thm:absorption}[ZH]——[ZH]1[ZH]——[ZH]。[ZH]：(a) [ZH]：[ZH] $\lambda$ [ZH]（[ZH]），[ZH]CEC[ZH]；(b) [ZH]：[ZH]，[ZH]、[ZH]。(a)[ZH](b)[ZH]6[ZH]。
\end{remark}

\begin{proposition}[[ZH]]
\label{prop:intervention-window}
[ZH] $\mathcal{W}_i$ [ZH] $S_i$ [ZH]（[ZH]、[ZH]、CEC[ZH]）[ZH]。[ZH] $\eta_i = \max_{\iota \in \mathcal{W}_i} \mathbb{P}[\text{[ZH]}\ \iota\ \text{[ZH]}]$。[ZH]M1--M5[ZH]：
\begin{equation}
...
\begin{proof}
[ZH] $S_1$，[ZH]，[ZH]。[ZH] $S_3$，[ZH]CEC[ZH]"[ZH]"[ZH]（[ZH]\ref{thm:asymptotic-uniqueness}），[ZH]。[ZH] $S_5$，[ZH]，[ZH]——[ZH]。[ZH]。
\end{proof}

\begin{remark}[[ZH]]
[ZH]\ref{prop:intervention-window}[ZH]：[ZH] $S_3$（[ZH]）——[ZH]NPE[ZH]——[ZH]。[ZH]，[ZH]。[ZH]6[ZH]。
\end{remark}

\subsection{Stage 6: [ZH] (Universal Harmony)}

\label{sec:stage6}

[ZH]（§5.2--§5.2.1）[ZH] $S_1$（[ZH]）[ZH] $S_5$（[ZH]）[ZH]，[ZH] $S_5$ [ZH]（[ZH]M5）。[ZH]——[ZH]——[ZH]\textit{[ZH]}。[ZH]，[ZH] $S_5$ [ZH]，[ZH]：[ZH]CEC[ZH]，[ZH]。[ZH]\textit{[ZH]}（Universal Harmony）。

\begin{definition}[[ZH] $S_6$]
\label{def:S6}
[ZH] $S_6$ [ZH]：
\begin{enumerate}[label=(\roman*), itemsep=2pt]
\item \textbf{CEC[ZH]：} [ZH] $\mathcal{E}_t$ [ZH]（[ZH]6[ZH] IDAA）[ZH]，[ZH]、[ZH]。CEC[ZH]；
\item \textbf{[ZH]：} [ZH]——[ZH]、[ZH]、Spring[ZH]——[ZH]，[ZH]；
\item \textbf{[ZH]：} Yajie[ZH]（[ZH]、[ZH]、[ZH]）[ZH]，[ZH]（Maintainer）[ZH]，[ZH]；
\item \textbf{[ZH]：} [ZH]，[ZH]（[ZH](\ref{eq:audit-function})[ZH] $\mathcal{V}$ [ZH]），[ZH] $\lambda$ [ZH]——[ZH]，[ZH]。
\end{enumerate}
\end{definition}

\begin{definition}[[ZH]]
\label{def:markov-assumptions-extended}
[ZH]M1--M5（[ZH]\ref{def:markov-assumptions}）[ZH]，[ZH]：

\begin{enumerate}[label=\textbf{M\arabic*}, leftmargin=*, itemsep=4pt]
\setcounter{enumi}{5}
\item \textbf{$S_5$ [ZH]：} $S_5$（[ZH]）[ZH]。[ZH] $S_5$ [ZH]，[ZH] $D_t \in \{0, 1\}$ [ZH]，[ZH] $D_t = 1$ [ZH] $t$，[ZH]CEC[ZH]CEC[ZH]。$D_t$ [ZH] $\pi_{\text{political}} \in [0, 1]$，[ZH]CEC[ZH]。\hfill\textit{[ZH]：[ZH]——CEC[ZH]（[ZH]、[ZH]）[ZH]CEC[ZH]。[ZH]。}

\item \textbf{$S_6$ [ZH]：} [ZH] $S_6$（[ZH]），[ZH]。[ZH] $p_{66}(|\mathcal{E}|) = 1$ [ZH] $|\mathcal{E}|$，[ZH] $j < 6$，$p_{6j}(|\mathcal{E}|) = 0$。\hfill\textit{[ZH]：CEC[ZH]，[ZH]——[ZH]CEC[ZH]——[ZH]，[ZH]CEC[ZH]。}

\item \textbf{$S_5 \to S_6$ [ZH]：} [ZH]：
\begin{equation}
p_{56}(D_t, \pi_{\text{political}}) = D_t \cdot \pi_{\text{political}}
\end{equation}
[ZH] $D_t = \mathbb{I}[\text{[ZH] }t\text{ [ZH]CEC[ZH]}]$。[ZH]——[ZH] $D_t$ [ZH]——[ZH] $\pi_{\text{political}}$。\hfill\textit{[ZH]：[ZH]——[ZH]。[ZH] $\pi_{\text{political}}$ [ZH]。}
\end{enumerate}
\end{definition}

[ZH]M6--M8[ZH]，[ZH] $\tilde{\mathbf{P}}(|\mathcal{E}|)$ [ZH] $6 \times 6$ [ZH]，[ZH]：
\begin{equation}
\begin{pmatrix}
...
\begin{enumerate}[label=(\roman*), itemsep=6pt]
\item \textbf{[ZH]：} [ZH] $X_0 = S_i$（$i \in \{1, \ldots, 5\}$）[ZH]，[ZH] $\{X_t\}_{t \geq 0}$ [ZH]1[ZH] $S_6$：
\begin{equation}
\mathbb{P}\left[\exists t < \infty : X_t = S_6 \mid X_0 = S_i\right] = 1
\end{equation}

\item \textbf{[ZH]：} [ZH]。[ZH]：[ZH]1[ZH] $S_1 \to S_2 \to S_3 \to S_4 \to S_5$（[ZH]\ref{thm:absorption}[ZH](i)）。[ZH]：[ZH] $S_5$ [ZH]，[ZH] $p_{56} = D_t \cdot \pi_{\text{political}}$ [ZH] $S_6$。[ZH] $S_5$ [ZH] $\tau_5$ [ZH]：
\begin{equation}
\mathbb{P}[\tau_5 = k] = (1 - p_{56})^{k-1} \cdot p_{56}, \quad k = 1, 2, \ldots
\end{equation}
[ZH] $\mathbb{E}[\tau_5] = 1 / p_{56}$。

\item \textbf{[ZH]：} [ZH] $S_1$ [ZH] $S_6$ [ZH]：
\begin{equation}
\mathbb{E}[T_{\text{absorb}}^{(6)} \mid X_0 = S_1] = \mathbb{E}[T_{\text{absorb}}^{(5)} \mid X_0 = S_1] + \frac{1}{p_{56}}
\end{equation}
[ZH] $\mathbb{E}[T_{\text{absorb}}^{(5)}]$ [ZH] $S_5$ [ZH]（[ZH]\ref{thm:absorption}[ZH](ii)）。

\item \textbf{[ZH]：} [ZH] $\pi_{\text{political}} = 0$，[ZH] $S_5$——[ZH]\ref{thm:absorption}[ZH]。[ZH] $\pi_{\text{political}} = 1$ [ZH] $D_t = 1$，[ZH] $S_5$ [ZH] $S_6$——[ZH]。[ZH] $\pi_{\text{political}} \in (0, 1)$，[ZH] $S_5$ [ZH]，[ZH]（heavy tail）——[ZH] $\pi_{\text{political}}$ [ZH]。

\item \textbf{[ZH]——[ZH]：} [ZH] $S_5$（[ZH]）[ZH]（[ZH]M5）[ZH]\textit{[ZH]}[ZH]。[ZH]，$S_6$（[ZH]）[ZH]。[ZH]\ref{thm:absorption}[ZH]"[ZH]1[ZH] $S_5$"[ZH]"[ZH]1[ZH] $S_6$"，[ZH] $S_5$ [ZH] $S_6$ [ZH]。[ZH] [ZH] (Spring SE-1) [ZH]：[ZH]——$S_1 \to S_5$ [ZH]，$S_5 \to S_6$ [ZH]。

[ZH]：\textbf{[ZH]——[ZH]-[ZH]（§11.4）[ZH]CEC[ZH]——[ZH]，[ZH]。[ZH]（CEC[ZH]）[ZH] $S_5$ [ZH]（[ZH]——[ZH]CEC[ZH]），[ZH] $S_6$ [ZH]：[ZH]。}
\end{enumerate}
\end{theorem}

\begin{proof}
\textbf{(i)} [ZH] $\mathcal{S}' = \{S_1, \ldots, S_6\}$。[ZH]M6--M8[ZH]，$S_5$ [ZH]（transient）——[ZH] $p_{56} > 0$ [ZH] $S_5$（[ZH] $\pi_{\text{political}} > 0$ [ZH] $D_t = 1$ [ZH]）。[ZH]M7，$S_6$ [ZH]。[ZH]（Kemeny \& Snell, 1976, [ZH]3.1.1），[ZH]，[ZH]1[ZH]。[ZH] $S_6$，[ZH] $S_6$ [ZH]1[ZH]。

\textbf{(ii)} [ZH]M3（[ZH]）[ZH]，[ZH] $S_1 \to \cdots \to S_5$（[ZH] $S_i$ [ZH]），[ZH] $S_6$——[ZH] $p_{i6} = 0$ [ZH] $i < 5$（$S_6$ [ZH]CEC[ZH]——[ZH]，[ZH]）。[ZH] $S_5$ [ZH]，[ZH] $S_6$ [ZH]，[ZH] $p_{56}$。[ZH] $\tau_5$ [ZH]，[ZH]。

\textbf{(iii)} [ZH]（[ZH]：[ZH]+[ZH] $\tau_1$ [ZH] $\tau_4$；[ZH]：[ZH] $\tau_5$），[ZH]。

\textbf{(iv)} [ZH] $p_{56}$ [ZH]。

\textbf{(v)} [ZH]（$S_5$）[ZH]"[ZH]"[ZH]——[ZH]M3[ZH]——[ZH]\textit{[ZH]}[ZH]（[ZH]），[ZH]\textit{[ZH]}[ZH]（CEC[ZH]）。M5[ZH]：[ZH]（$p_{5j} = 0$ [ZH] $j < 5$——[ZH]），[ZH]（$p_{56} > 0$——CEC[ZH]）。"[ZH]"[ZH]：(a) CEC[ZH]（$S_4 \to S_5$）；(b) [ZH]（[ZH]）[ZH]（$S_5 \to S_6$）；(c) [ZH]，[ZH]。
\end{proof}

\begin{corollary}[[ZH]——[ZH]]
\label{cor:S6-adoption-equivalence}
[ZH] $S_6$（[ZH]）[ZH]，[ZH] $\Gamma^{\text{NP}}$（[ZH]\ref{def:assumptions-npe}）[ZH](\ref{eq:all-adopt-condition})[ZH]：[ZH] $i, j \in N$：
\begin{equation}
\Delta_i(|\mathcal{E}^{\text{public}}|) = \Delta_j(|\mathcal{E}^{\text{public}}|) \triangleq \Delta^{\text{public}}
\end{equation}
[ZH]。NPE[ZH]"[ZH]CEC[ZH]"[ZH]"[ZH]CEC[ZH]"。[ZH] $\Gamma^{\text{NP}}$ [ZH] $S_6$ [ZH]——[ZH]，[ZH]（[ZH] $\Delta^{\text{public}} \geq \lambda - \kappa$），[ZH]。

\textbf{[ZH]：} [ZH]\ref{cor:first-mover-decay}[ZH] $S_6$ [ZH]——[ZH]，[ZH]\textit{[ZH]}。[ZH]"[ZH]"；[ZH]CEC[ZH]。"[ZH]"[ZH]——[ZH]"[ZH]"[ZH]，[ZH]，[ZH]"[ZH]"[ZH]。
\end{corollary}

\begin{proof}
[ZH] $S_6$ [ZH]，CEC[ZH]（[ZH]\ref{def:S6}[ZH](i)）[ZH] $|\mathcal{E}_i^{\text{accessible}}| = |\mathcal{E}^{\text{public}}|$ [ZH] $i$ [ZH]——[ZH]CEC[ZH]。[ZH] $\Delta(\cdot)$ [ZH]（[ZH]\ref{eq:adoption-advantage-def}），$\Delta_i$ [ZH]CEC[ZH]，[ZH] $i$ [ZH]。[ZH] $\Delta^{\text{public}} \geq \lambda - \kappa$ [ZH]。[ZH]，$(A, \ldots, A)$ [ZH]——[ZH]。
\end{proof}

\begin{remark}[[ZH]"[ZH]"[ZH]]
[ZH]\ref{thm:universal-harmony-absorption}[ZH] $S_5 \to S_6$ [ZH] Fukuyama(1989)[ZH]"[ZH]"。[ZH]"[ZH]"——[ZH]\textit{[ZH]}[ZH]。[ZH] $S_6$ [ZH]，[ZH]：(a) [ZH]——[ZH]，[ZH]"[ZH]CEC"[ZH]"[ZH]"；(b) [ZH]——[ZH]，[ZH]；(c) [ZH]——[ZH]、[ZH]。$S_6$ [ZH]\textit{[ZH]}——[ZH]，[ZH]。[ZH]，[ZH]。
\end{remark}

\begin{remark}[[ZH]NPE[ZH]]
[ZH]\ref{cor:first-mover-decay}（[ZH]3.2[ZH]）[ZH]\ref{thm:universal-harmony-absorption}（[ZH]）[ZH]：

\begin{enumerate}[label=(\arabic*), leftmargin=*]
\item NPE[ZH]\textit{[ZH]}[ZH]：CEC[ZH]，$\Delta_i(|\mathcal{E}|)$ [ZH]，[ZH]。[ZH]——[ZH]（[ZH]4[ZH]SWIFT[ZH]）。

\item NPE[ZH]\textit{[ZH]}：[ZH]\ref{cor:first-mover-decay}[ZH](iii)[ZH]CEC[ZH]。[ZH] $\pi_{\text{political}}$ [ZH]，[ZH] $\pi_{\text{political}}$ [ZH]：(a) [ZH]——[ZH] $S_3$ [ZH]（[ZH]\ref{prop:intervention-window}）；(b) [ZH]——[ZH] $\pi_{\text{political}}$（[ZH] $\lambda$ [ZH] $c^{\text{develop}}$）；(c) [ZH]——[ZH]SWIFT[ZH]，[ZH] $\pi_{\text{political}}$。

\item NPE[ZH]\textit{[ZH]}[ZH]（$S_6$）：CEC[ZH]，NPE[ZH]。[ZH]——[ZH]"[ZH]"（[ZH]CEC[ZH]），[ZH]"[ZH]"（[ZH]CEC[ZH]）。
\end{enumerate}

[ZH]6[ZH]：[ZH]1（IDAA[ZH]）[ZH]，[ZH]5（[ZH]）[ZH] $S_3$ [ZH]，[ZH]6（[ZH]）[ZH] $S_6$ [ZH]。
\end{remark}

\begin{remark}[[ZH]：[ZH]]
\label{rem:first-mover-duty}
[ZH]\ref{cor:first-mover-decay}[ZH]\ref{thm:universal-harmony-absorption}[ZH]，[ZH]，[ZH]：

\textbf{(1) [ZH]"[ZH]"。} "[ZH]"[ZH]——[ZH]，[ZH]。SCX[ZH]。[ZH]（[ZH]\ref{cor:everyone-equal}）[ZH]：[ZH]。[ZH]，[ZH]——[ZH]，[ZH]。

\textbf{(2) [ZH]"[ZH]，[ZH]"。} [ZH]CEC[ZH]——[ZH]、[ZH]、[ZH]。[ZH]，[ZH]。[ZH]（[ZH]3）[ZH]：[ZH]，[ZH]。

\textbf{(3) [ZH]："[ZH]，[ZH]。"} [ZH]（MAC[ZH]），[ZH]SCX[ZH]"[ZH]"[ZH]"[ZH]"。[ZH]——[ZH]。CEC[ZH]：[ZH]（$T^*$[ZH]），[ZH]，[ZH]。

\textbf{(4) [ZH]，[ZH]。} [ZH]"[ZH]"——[ZH]：(i) [ZH]（[ZH]）；(ii) [ZH]（[ZH]）；(iii) [ZH]，[ZH]（$c^{\text{develop}}$ [ZH] $\lambda$），[ZH]。[ZH]"[ZH]"——[ZH]。[ZH]，[ZH]——[ZH]。

\textbf{(5) [ZH]"[ZH]"——[ZH]"[ZH]"。} $S_6$ [ZH]（[ZH]\ref{def:S6}）[ZH]。[ZH] $S_1 \to S_5$ [ZH]——[ZH]——[ZH] $S_5 \to S_6$ [ZH]，[ZH]"[ZH]"。[ZH]——[ZH]MAC[ZH]：[ZH]。[ZH]，[ZH]，[ZH]。
\end{remark}
...
\begin{corollary}[Maintainer[ZH] (The Maintainer's Audit Obligation)]
...
[ZH] requires that this obligation applies universally. The Maintainer does not selectively audit enemies and spare friends. The audit is the same for everyone—because the theorem requires it, and because selective audit would itself be detectable as bias, destroying the equilibrium's credibility.
...
\begin{corollary}[[ZH] (Audit Exposure of Non-Adopters)]
...
A corporation that deploys Yajie internally—using its own employees, on its own infrastructure, reporting to its own management—has not satisfied the independence condition of Theorem~1 ([ZH]). The employee who audits her employer's data faces a structural conflict: her career advancement depends on her employer's satisfaction, and her employer's satisfaction depends, in part, on favorable audit outcomes. Even if she resists this pressure, her employer cannot \textit{know} that she has resisted it—and therefore cannot cite her audit as independent verification.
...
\begin{corollary}[[ZH] (The Internal Audit Independence Paradox)]
\label{cor:internal-audit-paradox}
Let $\mathcal{A}_{\text{internal}}$ be an audit department of organization $O$, and let $M_{\text{internal}}$ be its expert ensemble. Under the AAE framework, the condition $M_{\text{eff}} = M/(1+(M-1)\bar{\rho})$ (Theorem~6.1) applies with $\bar{\rho} > 0$ whenever the experts share the same employer—because their errors are correlated through shared incentives. The effective number of independent experts degrades. In the limit where the employer can terminate all $M$ auditors, $\bar{\rho} \to 1$ and $M_{\text{eff}} \to 1$—the entire internal audit department reduces to the epistemic equivalent of a single observer, regardless of headcount. This degradation is a direct consequence of [ZH] (Theorem~2): when the features of independence are weak, the detection guarantee collapses. An internal audit report signed by fifty employees carries no more independence guarantee than a report signed by one.
\end{corollary}
...
\begin{corollary}[[ZH] (The Disprove-or-Protect Deadline)]
...
The stone thus establishes a clean boundary around legitimate criticism. \textbf{Academic refutation is the only legitimate path.} Anyone may attack the 105 theorems—by finding a proof error, constructing a counterexample, or demonstrating a logical contradiction. Such criticism is welcome; it is the Disprove path, and it advances knowledge regardless of outcome. \textbf{Personal attack, moral condemnation, or historical judgment are not legitimate.} They are not arguments—they are admissions. A critic who cannot find a mathematical error but attacks the author's character, motives, or right to speak has conceded the mathematical argument. The attack is not skepticism. It is a confession: the critic fears the audit and has no other weapon. Such a critic is not a scholar. Such a critic is a bad type, self-revealed. The boundary is not arbitrary. It follows from Theorem~3 ([ZH]): a claim without stated, verifiable assumptions is mathematically empty. "This person is morally bad" is a claim. Where are the assumptions? Where is the verification protocol? If none are stated, the claim is void—not because it is offensive, but because it fails the only standard that the framework recognizes. The framework does not protect the author from criticism. It protects criticism from itself—by requiring that all claims, including claims about the author, meet the same standard.
...
[ZH]（Audit Guarantee）[ZH]——[ZH]4.5--4.7[ZH]——[ZH]。[ZH]。

\begin{definition}[[ZH] $\Gamma^{\text{AD}}$]
\label{def:audit-deterrence-game}
[ZH] $\Gamma^{\text{AD}} = \langle N, (S_i)_{i \in N}, (u_i)_{i \in N}, \mathcal{V} \rangle$ [ZH]：
\begin{itemize}[itemsep=2pt]
\item [ZH] $N = \{1, \ldots, n\}$（[ZH]、[ZH]）；
\item [ZH] $i \in N$，[ZH] $S_i = \{P, \neg P\}$，[ZH] $P$ [ZH]"[ZH]Yajie[ZH]"（partnership），$\neg P$ [ZH]"[ZH]"；
\item [ZH] $u_i: S \to \mathbb{R}$；
\item \textbf{[ZH]} $\mathcal{V}: 2^{\mathcal{D}} \times S \to [0,1]$，[ZH] $\mathcal{V}(\mathcal{D}_i, s)$ [ZH] $s$ [ZH]，[ZH] $i$ [ZH] $\mathcal{D}_i$ [ZH]。
\end{itemize}
\end{definition}
...
\begin{cases}
0 & \text{[ZH] } s_i = P \quad \text{（[ZH]：[ZH]）}\\
\rho \cdot \left(1 - \prod_{j: s_j = P} (1 - q_j)\right) & \text{[ZH] } s_i = \neg P
\end{cases}
...
[ZH]：
\begin{itemize}[itemsep=2pt]
\item $\rho \in (0, 1]$ [ZH]Yajie[ZH]（[ZH]）[ZH]。[ZH]Yajie，[ZH]，$\rho = 0$；
\item $q_j \in (0, 1]$ [ZH] $j$ [ZH] $i$ [ZH]。[ZH] $j$ [ZH]——[ZH]，[ZH] $j$ [ZH]；
\item [ZH] $\prod_{j: s_j = P} (1 - q_j)$ [ZH]\textit{[ZH]}[ZH] $i$ [ZH]。[ZH] $i$ [ZH]。
\end{itemize}

[ZH]：[ZH]——$\partial \mathcal{V} / \partial (\#\{j: s_j = P\}) > 0$。[ZH]"[ZH]"[ZH]：[ZH]，[ZH]。

\begin{definition}[[ZH]]
\label{def:ad-assumptions}
\begin{enumerate}[label=\textbf{D\arabic*}, leftmargin=*, itemsep=4pt]
\item \textbf{[ZH]：} [ZH] $i$ [ZH] $\mathcal{D}_i$ [ZH]（[ZH] $i$ [ZH]）[ZH] $p_i \in [0,1]$。$p_i$ [ZH] $i$ [ZH]。[ZH] $p_i$ [ZH] $F$，[ZH] $[0,1]$。\hfill\textit{[ZH]：[ZH]——[ZH]"[ZH]"（unknown unknowns）。}

\item \textbf{[ZH]：} [ZH] $i$ [ZH]（[ZH] $\mathcal{V}(\mathcal{D}_i, s) > 0$ [ZH]），[ZH]1[ZH]。\hfill\textit{[ZH]：[ZH]\ref{thm:scx-up}（[ZH] (The Honest Person Theorem)）[ZH]。[ZH]。"[ZH]"——[ZH]1，[ZH]。}

\item \textbf{[ZH]：} [ZH] $i$ [ZH]，$i$ [ZH] $L_i > 0$（[ZH]、[ZH]、[ZH]）。$L_i$ [ZH] $i$ [ZH]。\hfill\textit{[ZH]：$L_i$ [ZH]"[ZH]"[ZH]——[ZH]。}

\item \textbf{[ZH]：} [ZH] $P$（[ZH]）[ZH] $i$ [ZH] $c_i^{\text{adopt}} > 0$（[ZH]、[ZH]），[ZH] $\Delta Q_i > 0$（[ZH]Yajie[ZH]）。[ZH] $B_i = V(Q_i + \Delta Q_i) - V(Q_i) - c_i^{\text{adopt}}$，[ZH] $V(\cdot)$ [ZH]。\hfill\textit{[ZH]：$B_i$ [ZH]——[ZH]。}

\item \textbf{[ZH]：} [ZH] $\mathcal{V}(\cdot)$ [ZH] $(\rho, \{q_j\}_{j \in N})$ [ZH]。\hfill\textit{[ZH]：[ZH]，[ZH]，[ZH]。}
\end{enumerate}
\end{definition}
...
u_i(s_i, s_{-i}) =
\begin{cases}
V(Q_i + \Delta Q_i) - c_i^{\text{adopt}} & \text{[ZH] } s_i = P \\
V(Q_i) - \mathcal{V}(\mathcal{D}_i, s) \cdot p_i \cdot L_i & \text{[ZH] } s_i = \neg P
\end{cases}
\label{eq:ad-payoffs}
\end{equation}

[ZH]：[ZH] $s_i = P$，$\mathcal{V}(\mathcal{D}_i, s) = 0$（[ZH]——[ZH](\ref{eq:audit-function})[ZH]）。[ZH] $s_i = \neg P$，$\mathcal{V}(\mathcal{D}_i, s)$ [ZH](\ref{eq:audit-function})[ZH]。

\begin{theorem}[[ZH]]
\label{thm:mutual-deterrence}
[ZH]D1--D5[ZH]，[ZH] $\Gamma^{\text{AD}}$：

\begin{enumerate}[label=(\roman*), itemsep=6pt]
\item \textbf{[ZH]：} [ZH]-[ZH]（BNE），[ZH] $i$ [ZH] $p_i$ [ZH]：$s_i^*(p_i) \in \{P, \neg P\}$。

\item \textbf{[ZH]：} [ZH]，[ZH] $i$ [ZH]：[ZH] $\bar{p}_i$ [ZH]：
\begin{equation}
s_i^*(p_i) =
\begin{cases}
P & \text{[ZH] } p_i \leq \bar{p}_i \\
\neg P & \text{[ZH] } p_i > \bar{p}_i
\end{cases}
...
\item \textbf{[ZH]：} $\bar{p}_i$ [ZH] $B_i = V(Q_i + \Delta Q_i) - V(Q_i) - c_i^{\text{adopt}}$ [ZH]——[ZH]，[ZH]。$\bar{p}_i$ [ZH] $\mathcal{V}$ [ZH] $L_i$ [ZH]——[ZH]，[ZH]。

\item \textbf{[ZH]：} [ZH]（strategic complementarity）：[ZH] $j$ [ZH] $P$ [ZH] $\mathcal{V}(\mathcal{D}_i, s)$（[ZH] $s_i = \neg P$ [ZH]），[ZH] $i$ [ZH] $P$ [ZH]。[ZH] $\partial \mathcal{V} / \partial (\#\{k: s_k = P\}) > 0$。[ZH]——[ZH]"[ZH]"（[ZH]）[ZH]"[ZH]"（[ZH]）[ZH]。

\item \textbf{[ZH]：} [ZH]，\textit{[ZH]}[ZH]Yajie[ZH]。[ZH]\textbf{[ZH]}（mutual）——[ZH]（[ZH]，[ZH]，[ZH]）。[ZH]\textbf{[ZH]}——[ZH]（Theorem~\ref{thm:scx-up}[ZH]）。

\item \textbf{"[ZH]"[ZH]：} [ZH]\textit{[ZH]}[ZH]，[ZH]\textit{[ZH]}[ZH]。[ZH]，[ZH]\textit{[ZH]}[ZH]——[ZH] $P$ [ZH]，[ZH]。[ZH]。[ZH]：[ZH] $s^* = (P, \ldots, P)$，[ZH]；[ZH] $\neg P$ [ZH] $\mathcal{V}(\mathcal{D}_i, s^*) > 0$ [ZH]，[ZH]。
\end{enumerate}
\end{theorem}

\begin{proof}
\textbf{(i)} [ZH]（$|S_i| = 2$，[ZH] $[0,1]$ [ZH]，[ZH]）。[ZH]D1--D5[ZH]，[ZH]Milgrom \& Weber (1985)[ZH]Balder (1988)[ZH]-[ZH]，[ZH]。[ZH]，[ZH]，[ZH] $F$ [ZH]，[ZH]，[ZH]。

\textbf{(ii)} [ZH] $s_{-i}$ [ZH] $\mathcal{V}(\mathcal{D}_i, s)$，[ZH] $i$ [ZH] $P$ [ZH]：
\begin{align}
V(Q_i + \Delta Q_i) - c_i^{\text{adopt}} \geq V(Q_i) - \mathcal{V}(\mathcal{D}_i, s) \cdot p_i \cdot L_i
\end{align}
[ZH] $p_i \leq [V(Q_i + \Delta Q_i) - V(Q_i) - c_i^{\text{adopt}}] / [\mathcal{V}(\mathcal{D}_i, s) \cdot L_i] \triangleq \bar{p}_i$。[ZH]（[ZH]）[ZH] $\bar{p}_i < 0$——[ZH]，[ZH]（$p_i \geq 0$）[ZH]。[ZH](\ref{eq:threshold-strategy})[ZH]。

\textbf{(iii)} $\bar{p}_i$ [ZH] $B_i$ [ZH]、[ZH] $\mathcal{V}$ [ZH] $L_i$ [ZH]。[ZH]：[ZH]"[ZH]"；[ZH]。

\textbf{(iv)} [ZH]：[ZH] $\partial^2 u_i / \partial s_i \partial s_j > 0$（[ZH] $s_j = P$ [ZH]"[ZH]"[ZH]）。[ZH]Topkis (1979)[ZH]Milgrom \& Roberts (1990)[ZH]，[ZH]：(a) [ZH]；(b) [ZH]，[ZH]（[ZH]）[ZH]；(c) [ZH]，[ZH]。[ZH]，[ZH]（$\neg P$ [ZH]）[ZH]（$P$ [ZH]）[ZH]——[ZH]"[ZH]"[ZH]；[ZH]。

\textbf{(v)} [ZH](\ref{eq:audit-function})[ZH]：[ZH] $j$ [ZH] $\mathcal{V}(\mathcal{D}_i, s)$ [ZH] $\prod (1 - q_j)$ [ZH]，[ZH]。

\textbf{(vi)} [ZH] $s^* = (P, \ldots, P)$。[ZH] $i$，[ZH] $\neg P$ [ZH] $V(Q_i) - \rho \cdot [1 - \prod_{j \neq i} (1 - q_j)] \cdot p_i \cdot L_i$。[ZH] $i$，[ZH] $B_i$ [ZH]，$s^*$ [ZH]。[ZH]，[ZH]（$\mathcal{V} = 0$ [ZH]），[ZH]——[ZH]——[ZH]，[ZH]。
\end{proof}

\begin{corollary}[[ZH]]
\label{cor:deterrence-efficiency}
[ZH]D1--D5[ZH]，[ZH]——[ZH]——[ZH]。[ZH]，[ZH] $\mu = |\{i: s_i = P\}| / n$ [ZH]。[ZH]：
\begin{enumerate}[label=(\roman*)]
\item [ZH] $\mathbb{E}[\mathcal{V} \mid s_i = \neg P]$ [ZH] $\mu$ [ZH]；
\item [ZH] $\bar{p}_i(\mu)$ [ZH] $\mu$ [ZH]——[ZH]，[ZH]（[ZH]）；
\item [ZH] $\mu \to 1$ [ZH]，[ZH]——[ZH]，[ZH]。
\end{enumerate}
\end{corollary}

\begin{proof}
[ZH](\ref{eq:audit-function})，$\partial \mathcal{V} / \partial \mu > 0$（[ZH]）。[ZH]\ref{thm:mutual-deterrence}[ZH]，$\mathcal{V}$ [ZH]$\implies$[ZH]$\implies$[ZH]——[ZH]。[ZH] $\mu = 1$ [ZH]，$\mathcal{V}(\mathcal{D}_i, s) = \rho \cdot [1 - \prod_{j \neq i} (1 - q_j)]$ [ZH] $i$ [ZH]，[ZH]——[ZH]——[ZH]。
\end{proof}

\begin{remark}[[ZH]]
[ZH]\ref{thm:mutual-deterrence}[ZH]（Schelling, 1960, 1966）[ZH]：(a) [ZH]\textit{[ZH]}[ZH]\textit{[ZH]}[ZH]——[ZH]，[ZH]；(b) [ZH]\textit{[ZH]}[ZH]——[ZH]"[ZH]"[ZH]，[ZH] (The Honest Person Theorem)（Theorem~\ref{thm:scx-up}）[ZH]，[ZH]；(c) [ZH]——[ZH]"[ZH]"（MAD）[ZH]，[ZH]；[ZH]，[ZH]。[ZH]：[ZH]\textit{[ZH]}[ZH]——[ZH]"[ZH]"[ZH]。[ZH]，[ZH]。
\end{remark}

\subsection{Mutual Deterrence: The Structural Logic of Involuntary Transparency [[ZH]]}

[ZH]，[ZH]\ref{thm:mutual-deterrence}[ZH]。

\subsection{[ZH]-[ZH] ([ZH])}

[ZH]（[ZH]\ref{thm:mutual-deterrence}）[ZH] (The Honest Person Theorem)（[ZH]\ref{thm:scx-up}）。[ZH]，[ZH]-[ZH]（Adoption-Audit Equilibrium, AAE）[ZH]。

[ZH]：[ZH]——[ZH]（[ZH]），[ZH]（[ZH]）。[ZH] $\mu$（[ZH]Yajie[ZH]）[ZH]：$\mu$ [ZH]（[ZH]），[ZH]，[ZH] $\mu$。[ZH]。

\begin{definition}[AAE[ZH]]
\label{def:aae-continuum}
[ZH] $\mathcal{I} = [0,1]$（Lebesgue[ZH]）。[ZH] $i \in \mathcal{I}$ [ZH] $\theta_i = (p_i, B_i) \in [0,1] \times \mathbb{R}$，[ZH] $p_i$ [ZH]（[ZH]D1），$B_i = V(Q_i + \Delta Q_i) - V(Q_i) - c_i^{\text{adopt}}$ [ZH]Yajie[ZH]（[ZH]）。[ZH] $G$ [ZH] $\Theta = [0,1] \times \mathbb{R}$ [ZH]。

[ZH] $i$ [ZH] $s_i \in \{D, \neg D\}$（[ZH]/[ZH]）。[ZH] $\mu = \int_{\mathcal{I}} \mathbb{I}[s_i = D] \, di$。

[ZH]：[ZH] $j$（[ZH] $s_j = D$）[ZH] $k$（[ZH] $s_k = \neg D$）[ZH] $q(\mu) \in (0, 1]$，[ZH] $q(\cdot)$ [ZH] $\mu$ [ZH]——[ZH]，[ZH]。
\end{definition}

\begin{definition}[AAE[ZH]]
\label{def:aae-assumptions}
\begin{enumerate}[label=\textbf{E\arabic*}, leftmargin=*, itemsep=4pt]
\item \textbf{[ZH]：} [ZH] $\mathcal{I} = [0,1]$，[ZH]。\hfill\textit{[ZH]：[ZH]，[ZH]。}

\item \textbf{[ZH]：} [ZH] $\theta_i = (p_i, B_i)$ [ZH] $G$ [ZH]。$G$ [ZH] $G_p$ [ZH] $[0,1]$，$G_B$ [ZH] $\mathbb{R}$，$p_i$ [ZH] $B_i$ [ZH]（[ZH]——[ZH]）。\hfill\textit{[ZH]：[ZH]，[ZH]LLN[ZH]。}

\item \textbf{[ZH]：} $q: [0,1] \to (0, 1]$ [ZH]、[ZH]，$q(0) > 0$（[ZH]，[ZH]）。\hfill\textit{[ZH]：[ZH]，[ZH]——[ZH]。}

\item \textbf{[ZH]：} [ZH](\ref{eq:ad-payoffs})[ZH]，[ZH] $\mu$ [ZH]：[ZH] $s_i = \neg D$，[ZH] $\mathcal{V}(\mu) = 1 - (1 - q(\mu))^{\mu}$（[ZH]——[ZH]，[ZH] $\mu$，[ZH] $q(\mu)$ [ZH] $i$）。[ZH] $s_i = D$，$\mathcal{V}(\mu) = 0$（[ZH]）。

\item \textbf{[ZH]：} [ZH] $s: \mathcal{I} \to \{D, \neg D\}$ [ZH]，[ZH] $\mu$ [ZH]。
\end{enumerate}
\end{definition}
...
\end{equation}
[ZH]：[ZH]（$p_i, \mathcal{V}(\mu), L_i$ [ZH]），[ZH] $B_i \geq \text{[ZH]}$。[ZH]——[ZH]。

[ZH]\textbf{[ZH]}（best-response correspondence）$\Phi: [0,1] \to 2^{[0,1]}$：
\begin{equation}
...
\end{equation}
[ZH] $L(p, B) = L$ [ZH]，[ZH]。$\Phi(\mu)$ [ZH]"[ZH] $\mu$ [ZH] $\mathcal{V}(\mu)$，[ZH]"。

\begin{theorem}[AAE[ZH] —— Kakutani[ZH]]
\label{thm:aae-fixed-point}
[ZH]E1--E5[ZH]，[ZH] $\Phi: [0,1] \to 2^{[0,1]}$ [ZH]Kakutani[ZH]，[ZH] $\mu^* \in \Phi(\mu^*)$。[ZH] $\mu^*$ [ZH]-[ZH]（AAE）[ZH]。

[ZH]：
\begin{enumerate}[label=(\roman*), itemsep=6pt]
\item \textbf{$\Phi$ [ZH] $[0,1]$ [ZH]：} [ZH] $\mu \in [0,1]$，$\Phi(\mu) \subseteq [0,1]$（[ZH]1）。

\item \textbf{$\Phi$ [ZH]：} [ZH] $\mu \in [0,1]$，$\Phi(\mu) \neq \emptyset$。\hfill\textit{[ZH](\ref{eq:br-correspondence})[ZH] $[0,1]$ [ZH]。}

\item \textbf{$\Phi$ [ZH]：} [ZH] $\mu \in [0,1]$，$\Phi(\mu)$ [ZH]。\hfill\textit{[ZH]，[ZH](\ref{eq:br-correspondence})[ZH]。[ZH] $G$ [ZH]，$\Phi(\mu)$ [ZH]（[ZH]）。}

\item \textbf{$\Phi$ [ZH]（upper hemicontinuous）：} [ZH] $\mu_n \to \mu$，$\tilde{\mu}_n \in \Phi(\mu_n)$，$\tilde{\mu}_n \to \tilde{\mu}$，[ZH] $\tilde{\mu} \in \Phi(\mu)$。\hfill\textit{[ZH] $\mathcal{V}(\mu)$ [ZH]（E3），[ZH] $\mu$ [ZH]（[ZH]，[ZH]）。}

\item \textbf{[ZH]：} [ZH]Kakutani(1941)[ZH]，[ZH] $\mu^*$ [ZH] $\mu^* \in \Phi(\mu^*)$。\hfill$\square$
\end{enumerate}
\end{theorem}

\begin{proof}
[ZH]Kakutani[ZH]。[ZH] $[0,1]$ [ZH] $\mathbb{R}$ [ZH]。[ZH] $\Phi$ [ZH]：

[ZH] $(\mu_n, \tilde{\mu}_n) \to (\mu, \tilde{\mu})$ [ZH] $\tilde{\mu}_n \in \Phi(\mu_n)$ [ZH] $n$ [ZH]。[ZH] $\tilde{\mu} \in \Phi(\mu)$。[ZH]：
\begin{equation}
\tilde{\mu}_n = \int_{\Theta} \mathbb{I}\left[B \geq -p \cdot \mathcal{V}(\mu_n) \cdot L(p, B)\right] dG(p, B)
\end{equation}
[ZH] $f_n(p, B) = \mathbb{I}[B \geq -p \cdot \mathcal{V}(\mu_n) \cdot L(p, B)]$ [ZH] $f(p, B) = \mathbb{I}[B \geq -p \cdot \mathcal{V}(\mu) \cdot L(p, B)]$（[ZH] $\mathcal{V}$ [ZH]），[ZH] $\{(p, B) : B = -p \cdot \mathcal{V}(\mu) \cdot L(p, B)\}$ [ZH]。[ZH] $G$-[ZH]（[ZH]E2[ZH] $G$ [ZH]Lebesgue[ZH]，[ZH]，[ZH]）。[ZH]，$\tilde{\mu}_n \to \int_{\Theta} f(p, B) dG = \tilde{\mu}$，[ZH] $\Phi$ [ZH]。[ZH]，[ZH]（Aliprantis \& Border, 2006, [ZH]17.11）。

[ZH]：[ZH] $[0,1]$，[ZH] $\Phi(\mu)$ [ZH]。[ZH]：[ZH]，[ZH]。[ZH] $G$ [ZH]，$\Phi(\mu)$ [ZH]，[ZH]，[ZH]。
...
[ZH]E1--E5[ZH]，AAE[ZH]。[ZH]：
\begin{enumerate}[label=(\roman*)]
\item [ZH] $\Phi(0) = 0$（[ZH]，[ZH]），[ZH] $\mu^* = 0$（[ZH]）[ZH]AAE——[ZH]。
\item [ZH] $\Phi(1) = 1$（[ZH]，[ZH]），[ZH] $\mu^* = 1$（[ZH]）[ZH]AAE——[ZH]。
\item [ZH] $\mu^* \in (0,1)$。[ZH]（[ZH]），[ZH] $\Phi'(\mu^*) < 1$。
\item [ZH] $\Phi$ [ZH]，[ZH] $\Phi$ [ZH] $q(\mu)$ [ZH] $G$ [ZH]。[ZH] $q(\mu)$ [ZH]S[ZH]（sigmoid）——[ZH]——[ZH] $\Phi$ [ZH]。
\end{enumerate}
\end{corollary}

\begin{proof}
[ZH]\ref{thm:aae-fixed-point}，$\Phi$ [ZH]。[ZH]。$\Phi(0) = 0$ [ZH] $(p, B) \in \text{supp}(G)$，$B < -p \cdot \mathcal{V}(0) \cdot L$ [ZH]——[ZH]，[ZH]（[ZH] $\mathcal{V}(0) = 0$，[ZH] $B < 0$ [ZH]，[ZH]）。[ZH] $\mu^* = 1$。[ZH] $\Phi$ [ZH]。
\end{proof}

\begin{proposition}[AAE[ZH]]
\label{prop:aae-welfare}
[ZH]E1--E5[ZH]，AAE[ZH]：
\begin{enumerate}[label=(\roman*)]
\item \textbf{[ZH]：} [ZH] $\mu^* > 0$ [ZH]AAE[ZH]，[ZH]。[ZH]。[ZH]（[ZH]）[ZH] $\mu^*$。
\item \textbf{[ZH]：} [ZH] $p_i$ [ZH] $B_i$ [ZH]（[ZH]，[ZH]——[ZH]），[ZH]AAE[ZH]\textit{[ZH]}：[ZH] $p_i$（[ZH]）[ZH]，[ZH] $p_i$（[ZH]）[ZH]。[ZH]。
\item \textbf{[ZH]：} [ZH] $\mu^* = 1$（[ZH]）[ZH]，[ZH]，[ZH]——[ZH]"[ZH]"[ZH]。
\item \textbf{[ZH]-[ZH]：} [ZH] $q(\mu)$ [ZH]（[ZH]），[ZH]（$B_i$ [ZH]），[ZH]（$B_i$ [ZH]）。[ZH]\textit{[ZH]}——[ZH] $q$ [ZH]。
\end{enumerate}
\end{proposition}

\begin{proof}
[ZH]\ref{thm:aae-fixed-point}[ZH](\ref{eq:adopt-condition})[ZH]。[ZH]，[ZH]Spence(1973)[ZH]：[ZH]——[ZH]（[ZH]）[ZH]，[ZH]。
\end{proof}

\begin{remark}[[ZH]：[ZH]]
[ZH]\ref{thm:aae-fixed-point}[ZH]，[ZH]：
\begin{enumerate}[label=(\arabic*), leftmargin=*]
\item \textbf{[ZH]（E1）[ZH]：} [ZH]（[ZH]，$n = 2$[ZH]$3$）[ZH]，[ZH](\ref{eq:br-correspondence})[ZH]，$\Phi(\mu)$ [ZH]。[ZH]Kakutani[ZH]，[ZH](1951)[ZH]——[ZH]。
\item \textbf{[ZH] $q(\mu)$ [ZH]（E3）：} [ZH]，$q(\mu)$ [ZH]——[ZH]，[ZH]。[ZH] $q(\mu)$ [ZH]"[ZH]"[ZH]"[ZH]+[ZH]"[ZH]，[ZH]。
\item \textbf{[ZH]（E2）[ZH]：} [ZH]（[ZH]：[ZH]），[ZH]。[ZH] $\Phi(\mu)$ [ZH]，[ZH]（[ZH]Schauder[ZH]）[ZH]Kakutani[ZH]。
\item \textbf{[ZH] $L$ [ZH]：} [ZH](\ref{eq:adopt-condition})[ZH] $p_i$ [ZH]。[ZH]（[ZH]——[ZH]，[ZH]），[ZH]，$\Phi$ [ZH]。[ZH]，[ZH]Brouwer（[ZH] $\Phi$ [ZH]）[ZH]（[ZH]Eilenberg-Montgomery, 1946，[ZH] $\Phi$ [ZH]acyclic upper semicontinuous[ZH]）[ZH]，[ZH]。
\end{enumerate}
\end{remark}

\section{SCX[ZH]：[ZH]、[ZH]}

[ZH]、[ZH]Yajie[ZH]。[ZH]：SCX[ZH]，[ZH]、[ZH]。[ZH]：(i) [ZH]——[ZH]——[ZH]（[ZH]）；(ii) [ZH]，[ZH]——[ZH]——[ZH]SCX[ZH]（[ZH]）；[ZH]；(iii) SCX[ZH]、[ZH]（[ZH]）。

\subsection{[ZH]：[ZH]，[ZH]}

[ZH]：[ZH]，[ZH]。[ZH]——[ZH]，[ZH]。SCX[ZH]，[ZH]。

\begin{definition}[[ZH]-[ZH]]
[ZH] $\mathcal{D}$ [ZH] $n$ [ZH]。$\mathcal{D}$ [ZH] $\mathcal{D}_{\text{clean}}$ [ZH] $\mathcal{D}_{\text{noise}}$：
\begin{equation}
\mathcal{D} = \mathcal{D}_{\text{clean}} \cup \mathcal{D}_{\text{noise}}, \quad \mathcal{D}_{\text{clean}} \cap \mathcal{D}_{\text{noise}} = \emptyset
\end{equation}
[ZH] $\mathcal{D}_{\text{noise}}$ [ZH]、[ZH]、[ZH]、[ZH]。[ZH] $\rho(\mathcal{D}) = |\mathcal{D}_{\text{clean}}| / |\mathcal{D}|$。
\end{definition}

\begin{theorem}[[ZH]]
\label{thm:storage-paradox}
[ZH] $V: 2^{\mathcal{D}} \to \mathbb{R}^+$ [ZH]，[ZH]。[ZH] $\rho^* \in (0, 1)$，[ZH] $\rho(\mathcal{D}) < \rho^*$ [ZH]：
\begin{equation}
V(\mathcal{D}_{\text{clean}}) > V(\mathcal{D})
\end{equation}
[ZH]：[ZH]。[ZH]，[ZH]SCX[ZH]（[ZH]Theorem 1[ZH]），[ZH]，[ZH] $\mathcal{D}_{\text{clean}}$ [ZH]。
\end{theorem}

\textit{Proof sketch.} [ZH] $\mathcal{D}$ [ZH] $f_{\mathcal{D}}$。[ZH] $\mathcal{D}_{\text{noise}}$ [ZH]：(a) [ZH]，[ZH] $(1-\rho)$ [ZH]（Natarajan et al., 2013）；(b) [ZH]，[ZH]。[ZH]Theorem 1，SCX[ZH]。[ZH]，[ZH] $\epsilon > 0$，[ZH] $k$ [ZH]1。[ZH]，[ZH] $k$，[ZH] $\hat{\mathcal{D}}_{\text{clean}}$ [ZH] $\mathbb{E}[V(\hat{\mathcal{D}}_{\text{clean}})] > V(\mathcal{D})$。\hfill $\square$

[ZH]。Theorem~\ref{thm:storage-paradox} [ZH]：[ZH]SCX[ZH]，[ZH]——[ZH]，[ZH]。[ZH]5.6[ZH]：CEC[ZH]，[ZH]CEC[ZH]，[ZH]。CEC[ZH]——[ZH]、[ZH]，[ZH]。[ZH]，[ZH]CEC[ZH]。[ZH]，[ZH]（[ZH]），[ZH]：[ZH]。[ZH]，[ZH]、CEC[ZH]——[ZH]。

\subsubsection{[ZH]：Jevons[ZH]}

Theorem~\ref{thm:storage-paradox} [ZH]→[ZH]→[ZH]。[ZH]，[ZH]——[ZH]，[ZH]。[ZH]，[ZH]，[ZH]：[ZH]Jevons[ZH]（Jevons, 1865）[ZH]——[ZH]，[ZH]。

\medskip
\noindent\textbf{1. [ZH]。}

SCX[ZH]——[ZH]CEC[ZH] $|\mathcal{E}_t|$ [ZH] $\theta(t)$ [ZH]——[ZH]：

\begin{definition}[[ZH]]
[ZH] $\mathcal{S}(t)$ [ZH] $t$ [ZH]，$\mathcal{G}(t)$ [ZH]。[ZH] $\alpha(t) = \theta(t) / \theta_{\max} \in [0, 1]$ [ZH] $\mathcal{S}(t)$：

\textbf{[ZH]：[ZH]（[ZH]）。} [ZH]，[ZH] $\mathcal{D}_{\text{clean}}$ [ZH]。[ZH]Theorem~\ref{thm:storage-paradox}，[ZH]。[ZH] $\kappa(\alpha) \in [0, 1]$ [ZH]：
\begin{equation}
\kappa(\alpha) = \rho(\mathcal{D}) + (1 - \rho(\mathcal{D})) \cdot (1 - \alpha)^{\eta}
\end{equation}
[ZH] $\eta > 0$ [ZH]。$\kappa(\alpha) \to \rho(\mathcal{D})$ [ZH] $\alpha \to 1$：[ZH]，[ZH]。

\textbf{[ZH]：[ZH]（[ZH]）。} [ZH]AI[ZH]。[ZH](\ref{eq:quality})–(\ref{eq:model})，[ZH] $Q_i^t$ [ZH] $M_i^{t+1}$。[ZH]，[ZH]，[ZH]：
\begin{equation}
\mathcal{G}(t) = \mathcal{G}_0 \cdot \left(1 + \beta \cdot \alpha(t)^{\gamma}\right)
\end{equation}
[ZH] $\beta > 0$ [ZH]，$\gamma > 0$ [ZH]。[ZH]Jevons[ZH]：[ZH]（[ZH]）[ZH]，[ZH]，[ZH]。
\end{definition}
...
[ZH]。[ZH]：
\begin{equation}
\frac{d\mathcal{S}}{dt} = \underbrace{\frac{d}{dt}\left[\kappa(\alpha(t)) \cdot \int_0^t \mathcal{G}(\tau) d\tau\right]}_{\text{[ZH]}} + \underbrace{\kappa(\alpha(t)) \cdot \mathcal{G}(t)}_{\text{[ZH]}}
\end{equation}

[ZH]Leibniz[ZH]：
\begin{equation}
\frac{d\mathcal{S}}{dt} = \underbrace{\kappa'(\alpha) \cdot \dot{\alpha}(t) \cdot \int_0^t \mathcal{G}(\tau) d\tau}_{\text{[ZH] }(<0)} + \underbrace{\kappa(\alpha(t)) \cdot \mathcal{G}(t)}_{\text{[ZH] }(>0)}
\end{equation}

[ZH]（$\kappa'(\alpha) < 0$，[ZH]），[ZH]。[ZH]。

\begin{definition}[[ZH]]
[ZH]。[ZH]：
\begin{equation}
\Phi_{\text{quality}}(\alpha) = \frac{\partial (\text{[ZH]})}{\partial \alpha} = \frac{\partial}{\partial \alpha}\left[\rho(\mathcal{D}) \cdot \int_0^t \mathcal{G}(\tau) d\tau\right]
\end{equation}
\begin{equation}
\Phi_{\text{quantity}}(\alpha) = \frac{\partial (\text{[ZH]})}{\partial \alpha} = \frac{\partial}{\partial \alpha}\left[\int_0^t \mathcal{G}(\tau) d\tau\right]
\end{equation}

[ZH]\textbf{[ZH]} $\alpha^*$ [ZH]：
\begin{equation}
\Phi_{\text{quality}}(\alpha^*) = \Phi_{\text{quantity}}(\alpha^*)
\end{equation}

[ZH] $\Phi_{\text{quality}}(\alpha) > \Phi_{\text{quantity}}(\alpha)$ [ZH]——[ZH]——[ZH]：$d\mathcal{S}/dt < 0$。[ZH]\textit{[ZH]}（denoising-dominated regime）。

[ZH] $\Phi_{\text{quality}}(\alpha) < \Phi_{\text{quantity}}(\alpha)$ [ZH]——[ZH]——[ZH]：$d\mathcal{S}/dt > 0$。[ZH]\textit{[ZH]}（generation-dominated regime）。

[ZH]：[ZH]（$\alpha \approx 0$），[ZH]（$\kappa'(\alpha)$ [ZH]，[ZH]，[ZH]），[ZH]（[ZH]），[ZH] $\Phi_{\text{quantity}} > \Phi_{\text{quality}}$，[ZH]。[ZH]（$\alpha \to 1$），[ZH]（$\kappa(\alpha) \to \rho(\mathcal{D})$），[ZH]（[ZH]，[ZH]），[ZH] $\Phi_{\text{quality}} > \Phi_{\text{quantity}}$，[ZH]。[ZH]，[ZH] $\alpha^* \in (0, 1)$ [ZH]。
\end{definition}

\medskip
\noindent\textbf{3. [ZH]：[ZH]。}

[ZH] $\mathcal{G}(t)$ [ZH] $\alpha(t)$ [ZH]。[ZH]，$\mathcal{G}(t)$ [ZH]\textit{[ZH]}[ZH]。[ZH]，[ZH]。

[ZH] $N$ [ZH]（[ZH]、[ZH]）。[ZH] $i$ [ZH] $t$ [ZH] $g_i(t)$，[ZH] $\mathcal{G}(t) = \sum_i g_i(t)$。[ZH] $i$ [ZH]：
\begin{equation}
u_i(g_i, \mathbf{g}_{-i}; \alpha) = \underbrace{V\left(g_i \cdot \underbrace{\left[1 - (1-\alpha)^{\eta}\right]}_{\text{[ZH]}}\right)}_{\text{[ZH]}} - \underbrace{C(g_i)}_{\text{[ZH]}} + \underbrace{\lambda \cdot \mathbb{I}\left[g_i > \bar{g}_{-i}\right]}_{\text{[ZH]}}
\end{equation}
[ZH] $V(\cdot)$ [ZH]（[ZH]），$C(\cdot)$ [ZH]（[ZH]），$\lambda > 0$ [ZH]\textit{[ZH]}——[ZH] $i$ [ZH]，$i$ [ZH]（[ZH]、[ZH]、[ZH]）。$\bar{g}_{-i}$ [ZH] $i$ [ZH]。

\begin{proposition}[[ZH]]
\label{prop:preemptive}
[ZH]（$\alpha \ll \alpha^*$），[ZH]，[ZH] $g^*(\alpha)$ [ZH]：
\begin{equation}
g^*(\alpha) = (C')^{-1}\left(V'(\cdot) \cdot [1 - (1-\alpha)^{\eta}] + \frac{\lambda}{N}\right)
\end{equation}
[ZH] $dg^*/d\alpha > 0$：[ZH]，[ZH]\textit{[ZH]}[ZH]，[ZH]：(a) [ZH]（$V'(\cdot)$ [ZH]），(b) [ZH] $\lambda/N$ [ZH]。

[ZH]\textit{[ZH]}[ZH]：[ZH] $\mathcal{G}(t)$ [ZH] $\alpha^*$ [ZH]。[ZH]"[ZH]"（front-running）[ZH]：[ZH]，[ZH]——[ZH]。[ZH] $\lambda$ [ZH]，[ZH] $N$ [ZH]（[ZH]）。
\end{proposition}

\begin{proof}
[ZH] $i$ [ZH] $\partial u_i / \partial g_i = 0$ [ZH]。[ZH]，$g_i = g^*$ [ZH] $i$ [ZH]，[ZH] $\mathbb{I}[g_i > \bar{g}_{-i}] = 0$（[ZH]）。[ZH] $V'(g^* \cdot [1 - (1-\alpha)^{\eta}]) \cdot [1 - (1-\alpha)^{\eta}] - C'(g^*) = 0$。[ZH] $g^*$ [ZH]。[ZH] $\lambda/N$ [ZH] $\lambda$ [ZH]，[ZH]。
\end{proof}

Proposition~\ref{prop:preemptive} [ZH]：[ZH]，[ZH]\textit{[ZH]}[ZH]——[ZH]。[ZH]；[ZH]，[ZH]。[ZH]"[ZH]，[ZH]"，[ZH]"[ZH]，[ZH]"。[ZH]：[ZH]（[ZH]）[ZH]，[ZH]。

[ZH]，[ZH]：

\begin{proposition}[[ZH]]
\label{prop:mature}
[ZH]（$\alpha > \alpha^*$），[ZH]，[ZH]\textit{[ZH]}，[ZH]：
\begin{equation}
g_i^{**}(\alpha) = (C')^{-1}\left(V'(\cdot) \cdot \rho(\mathcal{D})\right) \quad \text{[ZH]} \quad \text{retain}_i = \kappa(\alpha) \cdot \mathcal{D}_i
\end{equation}

[ZH]，[ZH]。[ZH]，[ZH] $\mathcal{S}(t)$ [ZH]，[ZH] $\sum_i |\mathcal{D}_{\text{clean}, i}^*|$。
\end{proposition}

\begin{proof}
[ZH] $\alpha > \alpha^*$ [ZH]，(a) [ZH] $\lambda$ [ZH]：[ZH]，[ZH]，[ZH]；(b) [ZH] $\kappa(\alpha)$ [ZH]，[ZH]（[ZH]Theorem~\ref{thm:storage-paradox}，[ZH]）[ZH]"[ZH]"[ZH]；(c) [ZH]：[ZH]。[ZH]。
\end{proof}

\medskip
\noindent\textbf{4. [ZH]：[ZH]。}

[ZH]Theorem~\ref{thm:storage-paradox}[ZH]Proposition~\ref{prop:preemptive}–\ref{prop:mature}，[ZH]：

\begin{enumerate}[label=\textbf{[ZH] \arabic*}:, leftmargin=*]
\item \textbf{[ZH]（$\alpha \approx 0$）}：[ZH]。[ZH]，[ZH]。[ZH]：$\mathcal{S}(t) \approx \int_0^t \mathcal{G}(\tau) d\tau$。

\item \textbf{[ZH]（$0 < \alpha < \alpha^*$）}：[ZH]，[ZH]。[ZH]，[ZH]（Proposition~\ref{prop:preemptive}）。[ZH]\textit{[ZH]}[ZH]——[ZH]——[ZH]（[ZH]→[ZH]→[ZH]）[ZH]（[ZH]）[ZH] $\mathcal{G}(t)$，[ZH]。[ZH]：[ZH]。

\item \textbf{[ZH]（$\alpha > \alpha^*$）}：[ZH]。[ZH]：[ZH]（[ZH]），[ZH]（[ZH]），[ZH]（[ZH]）。[ZH]，[ZH]。[ZH]：$\mathcal{S}(t) \to \sum_i |\mathcal{D}_{\text{clean}, i}^*|$。
\end{enumerate}

\begin{remark}[[ZH]]
[ZH]：[ZH]\textit{[ZH]}[ZH]。[ZH]。[ZH]（[ZH]2[ZH]），[ZH]SCX[ZH]"[ZH]"[ZH]——[ZH]。[ZH]：[ZH]。[ZH]：[ZH]2，[ZH]；[ZH]3，[ZH]，[ZH]。[ZH]，$\alpha^*$ [ZH] $\Phi_{\text{quality}}$ [ZH] $\Phi_{\text{quantity}}$ [ZH]——[ZH]，[ZH]、[ZH]。
\end{remark}

\begin{remark}[Spring[ZH]]
\label{rem:golden-standard}
Yajie[ZH]Spring[ZH]：[ZH]——[ZH] $\Delta\mathcal{E}_t \approx \emptyset$——[ZH]。[ZH]，[ZH]。[ZH]Spring[ZH]（Golden Standard）——[ZH] $\mathcal{D}_{\text{clean}}^*$，[ZH]。[ZH]：[ZH]，[ZH]。[ZH]，[ZH]，[ZH]Spring[ZH]。
\end{remark}

\subsection{[ZH]}

SCX[ZH]。[ZH]（[ZH]、[ZH]、[ZH]）[ZH]（[ZH]、[ZH]、[ZH]）[ZH]，[ZH]。[ZH]SCX[ZH]——[ZH]，[ZH]Theorem 3（[ZH] (The Honest Person Theorem)）[ZH]。

\begin{definition}[[ZH]]
[ZH] $i$ [ZH] $t$ [ZH] $\mathcal{D}_i^t$ [ZH] $M_i^t$。SCX[ZH]：
\begin{align}
...
\end{align}
[ZH] $Q_i^t$ [ZH]Yajie[ZH]，$\theta(\cdot)$ [ZH]CEC[ZH]（[ZH](3)），$C_i$ [ZH]，$U_i^{t+1}$ [ZH]/[ZH]，$h(\cdot)$ [ZH]。
\end{definition}

[ZH](\ref{eq:quality})–(\ref{eq:audit-growth})[ZH]：[ZH] → [ZH] → [ZH] → [ZH] → [ZH] → CEC[ZH] → [ZH]。[ZH]（cumulative causation）[ZH]，[ZH]Myrdal (1957) [ZH] Arthur (1990) [ZH]。

\textbf{Theorem 3[ZH]。} [ZH]——[ZH]\textit{[ZH]}[ZH]。[ZH] $j$，[ZH] $T$ [ZH]SCX[ZH]AI[ZH]。[ZH] $t > T$，[ZH] $j$ [ZH] $M_j^t$ [ZH] $i$ [ZH] $M_i^t$。[ZH] $j$ [ZH]：$M_j^t < M_i^t$ [ZH] (a) $j$ [ZH] $\mathcal{D}_j^t$ [ZH] $i$，[ZH] (b) $j$ [ZH] $f_j$ [ZH] $i$ [ZH] $f_i$，[ZH] (c) [ZH]？

Theorem 3（[ZH] (The Honest Person Theorem)）[ZH]：[ZH]、[ZH]，[ZH]。[ZH]Yajie[ZH]——[ZH]Yajie[ZH]CEC[ZH]，[ZH]CEC[ZH]——[ZH]。[ZH]，[ZH]：

\begin{equation}
\underbrace{M_j^t < M_i^t}_{\text{observable}} \quad \text{[ZH]} \quad \begin{cases}
\mathcal{D}_j^t \text{ [ZH]} &\text{([ZH])}\\
f_j \text{ [ZH]} &\text{([ZH])}\\
\text{[ZH]} &\text{([ZH])}
\end{cases}
\end{equation}

[ZH]——CEC[ZH]——[ZH]，[ZH]。[ZH]：[ZH]，[ZH]，[ZH]、[ZH]。[ZH]，[ZH]。

\begin{remark}[[ZH]]
[ZH]SCX[ZH]，[ZH]：(1) [ZH]、[ZH]（[ZH]）；(2) [ZH]（GPU[ZH]、[ZH]、[ZH]）；(3) [ZH]（[ZH]CEC[ZH] $|\mathcal{E}|^*$）；(4) [ZH]，[ZH]（[ZH]GDPR[ZH]），[ZH]。

[ZH]。[ZH](2)（[ZH]）[ZH](3)（[ZH]27[ZH]）[ZH]。[ZH](1)（[ZH]）[ZH](2)（[ZH]）[ZH]。[ZH]。

[ZH]，SCX[ZH]——[ZH]——[ZH]。[ZH]（normative claim），[ZH]（structural inference）：[ZH]。[ZH]，[ZH]；[ZH]、[ZH]（[ZH]）[ZH]，[ZH]。[ZH]——[ZH]、[ZH]、[ZH]、[ZH]——[ZH]（audit receivers）[ZH]：[ZH]（[ZH]）[ZH]，[ZH]CEC[ZH]。[ZH]——[ZH]，[ZH]，[ZH]——[ZH]（dependency theory）[ZH]"[ZH]–[ZH]"[ZH]（Prebisch, 1950; Frank, 1967）[ZH]：[ZH]，[ZH]。[ZH]，[ZH]：[ZH]–[ZH]，[ZH]。

\textbf{[ZH]——[ZH]。} [ZH]，[ZH]CEC[ZH]\textit{[ZH]}[ZH]。[ZH]5.2.2[ZH]（Stage 6: [ZH]）[ZH]\ref{cor:first-mover-decay}[ZH]：[ZH]。CEC[ZH]，[ZH]——[ZH]CEC[ZH]，"[ZH]"[ZH]。[ZH]——[ZH]-[ZH]，[ZH]CEC[ZH]——[ZH]（$S_6$）[ZH]（[ZH]\ref{cor:S6-adoption-equivalence}）。[ZH]，[ZH]：\textbf{[ZH]"[ZH]"[ZH]"[ZH]"，[ZH]}——[ZH]。[ZH]（CEC[ZH]）[ZH]（[ZH]），[ZH]（CEC[ZH]）[ZH]。[ZH]"[ZH]"[ZH]，[ZH]。[ZH]（[ZH]）[ZH]（[ZH]\ref{cor:first-mover-decay}[ZH]\ref{thm:universal-harmony-absorption}）。
\end{remark}

\subsection{[ZH]：[ZH]}

[ZH]：[ZH]。[ZH]——[ZH]、[ZH]。[ZH]\textit{[ZH]}[ZH]。

\begin{definition}[[ZH]]
[ZH] $\mathcal{D}_{\text{phys}}$ [ZH]（physically embedded data）——[ZH]，[ZH]、[ZH]、[ZH]。$\mathcal{D}_{\text{phys}}$ [ZH] $\theta_{\text{audit}}$ [ZH]：
\begin{equation}
\theta_{\text{audit}} = \theta\left( \mathcal{A}, \mathcal{S}, \mathcal{H}, \mathcal{D}_{\text{phys}} \right)
\end{equation}
[ZH] $\mathcal{A}$ [ZH]，$\mathcal{S}$ [ZH]（[ZH]、[ZH]、[ZH]），$\mathcal{H}$ [ZH]（[ZH]、[ZH]、[ZH]）。$\mathcal{S}$ [ZH] $\mathcal{H}$ [ZH]——[ZH]，[ZH]。[ZH]，[ZH]SCX[ZH]\textit{[ZH]}[ZH]：$\partial \theta_{\text{audit}} / \partial (\text{distance}) < 0$。
\end{definition}

[ZH]：[ZH]，[ZH]SCX[ZH]（[ZH]+[ZH]+[ZH]+Spring[ZH]），[ZH]、[ZH]。[ZH]（[ZH]），[ZH]（[ZH]），[ZH]（[ZH]）。[ZH]：[ZH]SCX[ZH]，[ZH]、[ZH]、[ZH]。

\begin{remark}[[ZH]：[ZH]]
[ZH]——[ZH]。[ZH]（Wrigley, 1988）；[ZH]（[ZH]、[ZH]、[ZH]）[ZH]、[ZH]（Amsden, 1989; Wade, 1990）。[ZH]，[ZH]——[ZH]，[ZH]，[ZH]，[ZH]，[ZH]。

SCX[ZH]。[ZH]SCX[ZH]——[ZH]、[ZH]、[ZH]、[ZH]CEC[ZH]Spring[ZH]——[ZH]，[ZH]：[ZH]。[ZH]SCX[ZH]，[ZH]，[ZH]。[ZH]：(a) [ZH]（[ZH]），(b) [ZH]（CEC[ZH]），(c) [ZH]，[ZH] (d) [ZH]（[ZH]）[ZH]。

[ZH]SCX[ZH]，[ZH] $\Delta w$ [ZH] $\Delta \theta_{\text{audit}}$。[ZH]SCX[ZH]，[ZH]——[ZH]。
\end{remark}

\textbf{[ZH]。} [ZH]（reshoring）[ZH]——[ZH]、[ZH]（[ZH]），[ZH]。\textbf{[ZH]，[ZH]；[ZH]，[ZH]，[ZH]、[ZH]、[ZH]。[ZH]，[ZH]。}[ZH]SCX[ZH]，[ZH]，[ZH]。[ZH]（[ZH]）[ZH]Yajie[ZH]、[ZH]，[ZH]。[ZH]——[ZH]。

[ZH]：SCX[ZH]——[ZH]、[ZH]、[ZH]。[ZH]SCX[ZH]（[ZH]，[ZH]）[ZH]：[ZH]，[ZH]\textit{[ZH]}[ZH]。[ZH]：[ZH]（[ZH]CEC[ZH]），[ZH]（[ZH]），[ZH]（[ZH]）。

\subsection{[ZH]-[ZH]}

[ZH]（§11.2–11.3）[ZH]SCX[ZH]。[ZH]：[ZH]，[ZH]\textit{[ZH]-[ZH]}（Manufacturing-Audit Complex, MAC）[ZH]。[ZH]。

\begin{definition}[[ZH]-[ZH]]
[ZH]-[ZH]：
\begin{enumerate}[label=(\roman*)]
    \item \textbf{[ZH]}：[ZH] $\mathcal{D}_{\text{phys}}$ [ZH]，[ZH]SCX[ZH]；
    \item \textbf{[ZH]}：[ZH]、Spring[ZH]、[ZH]，[ZH]CEC[ZH]；
    \item \textbf{[ZH]-[ZH]}：[ZH]，[ZH]GPU[ZH]、[ZH]。
\end{enumerate}
[ZH]，[ZH] $\theta_{\text{audit}}$ [ZH]，[ZH]-[ZH]。
\end{definition}

MAC[ZH]\textit{[ZH]}：[ZH]，[ZH]，[ZH]。[ZH]——[ZH]。[ZH]。

\subsubsection*{[ZH]}

[ZH] $A$ [ZH] $B$，[ZH] $A$ [ZH]（[ZH]GDP[ZH]，[ZH]），$B$ [ZH]（[ZH]GDP[ZH]，[ZH]、[ZH]、[ZH]）。[ZH] $A$ [ZH] $B$ [ZH]SCX[ZH]。[ZH]，[ZH]，[ZH]：

\begin{equation}
\pi_i(s_i, s_{-i}) = R_i - C_i(s_i) - L_i(s_i, s_{-i})
\end{equation}

[ZH] $s_i \in \{0, 1\}$ [ZH] $i$ [ZH]SCX[ZH]（$1 = $ [ZH]），$R_i$ [ZH]，$C_i(s_i)$ [ZH]，$L_i(s_i, s_{-i})$ [ZH]。[ZH]：

\begin{enumerate}[label=(\roman*)]
    \item \textbf{[ZH]}：$C_A(1) < C_B(1)$。[ZH] $A$ [ZH]——[ZH]、[ZH]Spring[ZH]。[ZH] $B$ [ZH]，[ZH]。
    \item \textbf{[ZH]}：$\Delta_A > \Delta_B$，[ZH] $\Delta_i = L_i(0, 1) - L_i(0, 0)$ [ZH]，$i$ [ZH]。[ZH]，[ZH]，[ZH]；[ZH]（[ZH]、[ZH]）[ZH]，[ZH]。
\end{enumerate}

[ZH]，[ZH]：

\begin{theorem}[MAC[ZH]]
\label{thm:mac-asymmetric}
[ZH] $C_A(1) < C_B(1)$ [ZH] $\Delta_A > \Delta_B$。[ZH] $\Omega$ [ZH] $(s_A^* = 1, s_B^* = 0)$——[ZH]，[ZH]。[ZH]，[ZH]：[ZH]（$B$ [ZH]）[ZH] $B$ [ZH]，[ZH] $A$ [ZH]。
\end{theorem}

\textit{Proof sketch.} [ZH]。[ZH] $C_B(1) > \Delta_B$ [ZH]，[ZH] $A$ [ZH]，$B$ [ZH] $s_B = 0$。[ZH] $\Delta_A > C_A(1)$ [ZH]，[ZH] $s_B = 0$，$A$ [ZH] $s_A = 1$。[ZH] $\Omega$ [ZH]（[ZH]，[ZH]，[ZH]，[ZH]）。[ZH] $C_B(1) > \Delta_B$ [ZH]：$B$ [ZH]，[ZH] $(1, 1)$ [ZH] $(1, 0)$ [ZH] $B$ [ZH]。$(1, 0)$ [ZH] $A$ [ZH]（$A$ [ZH]），[ZH] $B$ [ZH]，[ZH]。\hfill $\square$

\subsubsection*{Theorem 3[ZH]：[ZH]}

§11.2[ZH]MAC[ZH]。[ZH]-[ZH]，Theorem 3（[ZH] (The Honest Person Theorem)）[ZH]，[ZH]。

[ZH] $B$，[ZH]MAC[ZH]（$s_B^* = 0$）。$B$ [ZH]——[ZH]，[ZH]——[ZH]。[ZH] $B$ [ZH]AI[ZH]，[ZH]§11.2[ZH]：[ZH] $A$ [ZH]，[ZH] (a) $B$ [ZH]（[ZH]SCX[ZH]）[ZH]，[ZH] (b) $B$ [ZH]，[ZH] (c) $B$ [ZH]\textit{[ZH]}（[ZH]、[ZH]、[ZH]）[ZH] $A$ [ZH]。

[ZH]MAC[ZH]。[ZH]——[ZH]、[ZH]。[ZH]（[ZH]、[ZH]、[ZH]）[ZH]"ground truth"[ZH]——[ZH]"[ZH]"[ZH]"[ZH]"[ZH]。[ZH]：

\begin{remark}[[ZH]]
[ZH]SCX[ZH]\textit{[ZH]}[ZH]。[ZH] $\mathcal{D}_{\text{phys}}$ [ZH]——[ZH]（SI），[ZH]"[ZH]"[ZH]。[ZH] $\mathcal{D}_{\text{service}}$ [ZH]"[ZH]"[ZH]、[ZH]——[ZH]ground truth[ZH]。[ZH]：
\begin{equation}
\theta_{\text{audit}}(\mathcal{D}_{\text{phys}}) > \theta_{\text{audit}}(\mathcal{D}_{\text{service}})
\end{equation}
[ZH]SCX[ZH] $\mathcal{A}$ [ZH]。[ZH]，[ZH]。
\end{remark}

[ZH]，[ZH]：[ZH]（[ZH]），[ZH]\textit{[ZH]}[ZH]（[ZH]）。Theorem 3[ZH]：[ZH]"[ZH]"[ZH]"[ZH]"，[ZH]"[ZH]"[ZH]（[ZH]）[ZH]（[ZH]）。
...
\begin{enumerate}[label=(\alph*)]
    \item \textbf{[ZH]}（de jure standard）：[ZH]——[ZH]ISO/IEC 5259[ZH]（[ZH]）、ISO/IEC 42001（AI[ZH]）——[ZH]、[ZH]；
    \item \textbf{[ZH]}（de facto standard）：[ZH]——CEC[ZH]、[ZH]、Spring[ZH]——[ZH]"[ZH]"。
\end{enumerate}
[ZH]、[ZH]——[ZH]ISO/IEC 5259。[ZH]：[ZH]——CEC[ZH]、[ZH]、[ZH]——[ZH]（[ZH]，[ZH]）[ZH]。
\end{definition}

[ZH]：SCX[ZH]，[ZH]。[ZH]，[ZH]——[ZH]（[ZH]、[ZH]）[ZH]（Abbate, 1999; DeNardis, 2009）。[ZH]，[ZH]CEC[ZH]。

[ZH]MAC[ZH]，[ZH]：[ZH]（[ZH]），[ZH]。[ZH]，[ZH]——[ZH]。

\subsubsection*{[ZH]-[ZH]-[ZH]}

[ZH]。SCX[ZH]Spring[ZH]，[ZH] $k$ [ZH] $n$ [ZH]。[ZH]MAC[ZH]，[ZH]，[ZH]——[ZH]——[ZH]。
...
\end{equation}
[ZH] $E_i$ [ZH] $i$ [ZH]SCX[ZH]（[ZH]、[ZH]）。$\eta_i$ [ZH]。$\eta_i$ [ZH]，[ZH]。
\end{definition}

[ZH]——[ZH]（[ZH]、[ZH]、[ZH]GPU[ZH]）——[ZH]。[ZH]：

\begin{enumerate}[label=(\roman*)]
    \item \textbf{[ZH]}：[ZH]、[ZH]。[ZH]、[ZH]、[ZH]，[ZH]SCX[ZH]，[ZH]CEC[ZH]。
    \item \textbf{[ZH]}：SCX[ZH]GPU[ZH]AI[ZH]。[ZH]（[ZH]、[ZH]）[ZH]。[ZH]——[ZH]（[ZH]）[ZH]（[ZH]）——[ZH]。
\end{enumerate}

[ZH]，[ZH]-[ZH]-[ZH]。[ZH]、[ZH]（[ZH]），[ZH]——[ZH]，[ZH]。[ZH]（[ZH]），[ZH]——[ZH]、[ZH]IT[ZH]——[ZH]、[ZH]、[ZH]。

\begin{remark}[[ZH]]
[ZH]：SCX[ZH]——[ZH]，[ZH]-[ZH]——[ZH]。[ZH]、[ZH]，[ZH]SCX[ZH]CEC[ZH]，[ZH]。[ZH]MAC[ZH]（Theorem~\ref{thm:mac-asymmetric}）[ZH]，[ZH] $C_A(1)$ [ZH] $C_B(1)$ [ZH]——[ZH]，[ZH]，[ZH]。
\end{remark}

\subsubsection*{[ZH]：[ZH]}

[ZH]——[ZH]MAC[ZH]、[ZH]、[ZH]——[ZH]§11.3[ZH]：$\partial \theta_{\text{audit}} / \partial (\text{distance}) < 0$。[ZH]：[ZH]，[ZH]。[ZH]，[ZH]。[ZH]：

\begin{enumerate}[label=(\roman*)]
    \item \textbf{[ZH]}：[ZH]（[ZH]-[ZH]、[ZH]）[ZH]，[ZH]（Degen et al., 2017）。[ZH]SCX[ZH]，[ZH]。
    \item \textbf{[ZH]}：[ZH]——[ZH]——[ZH]，[ZH]。[ZH]。
\end{enumerate}

[ZH]。[ZH]，[ZH]：\textbf{[ZH]，[ZH]。[ZH]，[ZH]。}[ZH]，[ZH]——[ZH]，[ZH]，[ZH]。

\subsubsection*{[ZH]}

[ZH]，[ZH]SCX[ZH]（structural inferences）——[ZH]，[ZH]：

\begin{enumerate}[label=(\roman*)]
    \item [ZH]——[ZH]——[ZH]SCX[ZH]。[ZH]：[ZH]（§11.3）、[ZH]（[ZH]）、[ZH]-[ZH]-[ZH]（[ZH]）。
    \item [ZH]——[ZH]，[ZH]。[ZH]，[ZH]CEC[ZH]。
    \item [ZH]。[ZH]，[ZH]——[ZH]。
    \item [ZH]。[ZH]、[ZH]、[ZH]CEC[ZH]，[ZH]。[ZH]。
    \item \textbf{[ZH]——[ZH]（[ZH]）。} [ZH](i)--(iv)[ZH]——[ZH]——[ZH]（[ZH]5.2.2[ZH]）[ZH]\textit{[ZH]}[ZH]，[ZH]。CEC[ZH]（[ZH]\ref{cor:first-mover-decay}）[ZH]：(a) CEC[ZH]（[ZH]\ref{cor:self-reinforcing}[ZH]）；(b) [ZH]CEC[ZH]，[ZH]，CEC[ZH]；(c) CEC[ZH] $\Delta(|\mathcal{E}|)$ [ZH]（[ZH]\ref{cor:S6-adoption-equivalence}），[ZH]；(d) [ZH]"[ZH]"[ZH]"[ZH]"（[ZH]\ref{def:S6}），[ZH]。[ZH] $S_5$（[ZH]）[ZH] $S_6$（[ZH]）[ZH]——[ZH]，[ZH] $\pi_{\text{political}}$ [ZH]（[ZH]M8）。[ZH]：\textbf{[ZH]（[ZH]）[ZH]MAC[ZH]，[ZH]}——CEC[ZH]，[ZH]（[ZH]、[ZH]CEC[ZH]）。[ZH]，[ZH]。
\end{enumerate}

[ZH]，[ZH]——[ZH]——[ZH]。[ZH]。[ZH]、[ZH]、[ZH]，[ZH]。

\textbf{SCX[ZH]。} [ZH]：SCX[ZH]。[ZH]。Theorem~1（[ZH]）[ZH]Yajie[ZH]。[ZH]，[ZH]（[ZH]7nm[ZH]5nm[ZH]3nm[ZH]）[ZH]（[ZH]、[ZH]、[ZH]、[ZH]）[ZH]，[ZH]——[ZH]、[ZH]、[ZH]——[ZH]、[ZH]。[ZH]、[ZH]、[ZH]，[ZH]；[ZH]——[ZH]（[ZH]、[ZH]、[ZH]）[ZH]，[ZH]，[ZH]。SCX[ZH]，[ZH]，[ZH]。[ZH]：[ZH]。[ZH]、[ZH]，[ZH]。SCX[ZH]，[ZH]"[ZH]"——[ZH]——[ZH]，[ZH]。

\textbf{[ZH]：[ZH]。} SCX[ZH]，[ZH]。[ZH]：[ZH]§11.3[ZH]，[ZH]SCX[ZH]——[ZH]、[ZH]、[ZH]，[ZH]。[ZH]——[ZH]。[ZH]、[ZH]，[ZH]"[ZH]"[ZH]（[ZH]），[ZH]——[ZH]。[ZH]，[ZH]，[ZH]——[ZH]、[ZH]、[ZH]——[ZH]。SCX[ZH]，[ZH]。

\textbf{[ZH]——[ZH]。} SCX[ZH]，[ZH]\textit{[ZH]}[ZH]（[ZH]，[ZH]§11.4[ZH]），[ZH]\textit{[ZH]}[ZH]。[ZH]\ref{cor:first-mover-decay}[ZH]\ref{thm:universal-harmony-absorption}[ZH]：CEC[ZH]，[ZH]——[ZH]CEC[ZH]（[ZH] $\Delta(\cdot)$ [ZH]，[ZH]CEC[ZH] $\Delta^{\text{public}}$ [ZH] $\lambda - \kappa$），[ZH]CEC[ZH]，[ZH]。[ZH]（$S_6$）[ZH]，"[ZH]"[ZH]"[ZH]CERN"——[ZH]，[ZH]。[ZH]，[ZH]。[ZH]SCX[ZH]"[ZH]"[ZH]，[ZH]。

\textbf{[ZH]。} [ZH]。[ZH]，[ZH]：[ZH]（[ZH]、[ZH]、[ZH]）、[ZH]（[ZH]）、[ZH]（[ZH]）。SCX[ZH]，[ZH]，[ZH]：（i）[ZH]——[ZH]、[ZH]；（ii）[ZH]——[ZH]、[ZH]；（iii）[ZH]——CEC[ZH]、[ZH]。[ZH]：[ZH]（[ZH]，[ZH]），[ZH]——CEC[ZH]，[ZH]。SCX[ZH]，[ZH]。[ZH]，[ZH]：[ZH]CEC[ZH]，[ZH]、[ZH]，[ZH]。

\textbf{[ZH]：[ZH]。} [ZH]，[ZH]：[ZH]——[ZH]（§11.3）——[ZH]。[ZH]，[ZH]。[ZH]，[ZH]——[ZH]（Degen et al., 2017），[ZH]——[ZH]。[ZH]，[ZH]：[ZH]，[ZH]，[ZH]SCX[ZH]。[ZH]，[ZH]，[ZH]——[ZH]——[ZH]。[ZH]，[ZH]，[ZH]、[ZH]。[ZH]。[ZH]：[ZH]，[ZH]。[ZH]，[ZH]。
