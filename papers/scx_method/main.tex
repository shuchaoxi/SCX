...
\title{Data Quality and Model Architecture: State-Conditioned eXpertise}
...
\begin{enumerate}
    \item The \textbf{The Honest Person Theorem} (Theorem~3): distinguishing label noise from sample difficulty is mathematically impossible without additional structural assumptions.
