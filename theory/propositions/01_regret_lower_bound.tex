...
The original Proposition 1 (全局专家排序不足) established the trivial
...
\tightlist
\item
  SCX theoretical framework. \texttt{01\_SCX\_核心框架\_数学分析.md}
  Section 2.1
\item
  SCX mathematical foundations. \texttt{05\_数学根源与证明.md}
  Proposition 1
\item
