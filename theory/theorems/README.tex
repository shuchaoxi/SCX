...
\textbf{Logical Closure of the Three Theorems}: - \textbf{Theorem 1 (Positive Statement)}: 在 A1-A6 下,
SCX  SCX can detect noise - \textbf{Theorem 2 (Boundary Statement)}:  When features are weak, , SCX
 SCX degenerates to the loss baseline - \textbf{Theorem 3 (Necessity Statement)}: 无 A1-A6 时,
