...
| **2026-06-25** | SCX v0.1.0 Python 包完成：30 files, 6,269 lines of code, 259 tests 全部通过（3.37s）。同日创建 GitHub 私密仓库。代码全部由 AI (Claude Code) 根据用户的数学框架和设计方向生成。 | **个人电脑** |
...
| SCX Python 实现（`src/scx/`） | 个人电脑 | 居家 | 由 AI (Claude Code) 在用户指导下生成 |
...
> **关键声明**：SCX 项目所有理论工作、代码实现、实验验证均在**个人电脑**上完成，未使用学校设备或超算资源。孝感超算仅用于 EGP 项目（Paper 1-3）的 AlN v3 DFT 数据生成。
...
SCX Python 包的**所有代码**均由 AI 工具 **Claude Code (Anthropic)** 生成，具体分工如下：
